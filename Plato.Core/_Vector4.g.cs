...
[MethodImpl(AggressiveInlining)]  public Vector4 Log(Vector4 newBase) => this.ZipComponents(newBase, (a, b)  => a.Log(b));
...
[MethodImpl(AggressiveInlining)]  public Vector4 Round(Integer digits){
            var _var192 = digits;
            return this.MapComponents((x)  => x.Round(_var192));
        }

[MethodImpl(AggressiveInlining)]  public Vector4 RoundAwayFromZero(Integer digits){
            var _var193 = digits;
            return this.MapComponents((x)  => x.RoundAwayFromZero(_var193));
        }
...
public Vector4 SquareRoot { [MethodImpl(AggressiveInlining)] get  => this.MapComponents((x)  => x.SquareRoot); } 
...
[MethodImpl(AggressiveInlining)]  public Vector4 Lerp(Vector4 b, Vector4 t) => this.ZipComponents(b, t, (a1, b1, t1)  => a1.Lerp(b1, t1));

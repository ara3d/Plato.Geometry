...
namespace Plato
{
    ...
    public partial struct Bounds2D: IBounds<Point2D>, IArrayLike<Bounds2D, Point2D>
    {
        // Fields
        ...
        Point2D IBounds<Point2D>.Min { [MethodImpl(AggressiveInlining)] get => Min; }
        Point2D IBounds<Point2D>.Max { [MethodImpl(AggressiveInlining)] get => Max; }
...
public Point2D Size { [MethodImpl(AggressiveInlining)] get  => this.Max.Subtract(this.Min); } 
[MethodImpl(AggressiveInlining)]  public Point2D Lerp(Number amount) => this.Min.Lerp(this.Max, amount);
public Point2D Center { [MethodImpl(AggressiveInlining)] get  => this.Lerp(((Number)0.5)); } 

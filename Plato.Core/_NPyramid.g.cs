...
namespace Plato
{
    ...
    public partial struct NPyramid: ISolid
    {
        ...
        // ClosedX(NPyramid):Boolean; [ISolid=NPyramid;Self=NPyramid;]; <>
        public Boolean ClosedX { [MethodImpl(AggressiveInlining)] get  => ((Boolean)true); } 
// ClosedY(NPyramid):Boolean; [ISolid=NPyramid;Self=NPyramid;]; <>
        public Boolean ClosedY { [MethodImpl(AggressiveInlining)] get  => ((Boolean)true); } 

        // Unimplemented concept functions
        // Eval(NPyramid, Vector2):Vector3; [IProcedural=NPyramid;TOut=Vector3;TIn=Vector2;IProceduralSurface=NPyramid;ISolid=NPyramid;Self=NPyramid;]; <>

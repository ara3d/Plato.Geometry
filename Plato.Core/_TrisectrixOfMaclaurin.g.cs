...
namespace Plato
{
    ...
    public partial struct TrisectrixOfMaclaurin: IPolarCurve, IOpenShape
    {
        ...
        // GetRadius(TrisectrixOfMaclaurin, Angle):Number; [Self=TrisectrixOfMaclaurin;]; <>
        [MethodImpl(AggressiveInlining)]  public Number GetRadius(Angle t) => t.TrisectrixOfMaclaurin(this.A);
// EvalPolar(TrisectrixOfMaclaurin, Angle):PolarCoordinate; [IPolarCurve=TrisectrixOfMaclaurin;Self=TrisectrixOfMaclaurin;]; <>
        [MethodImpl(AggressiveInlining)]  public PolarCoordinate EvalPolar(Angle t) => (this.GetRadius(t), t);
// Eval(TrisectrixOfMaclaurin, Angle):Vector2; [IPolarCurve=TrisectrixOfMaclaurin;Self=TrisectrixOfMaclaurin;]; <>
        [MethodImpl(AggressiveInlining)]  public Vector2 Eval(Angle t) => this.EvalPolar(t);
// Eval(TrisectrixOfMaclaurin, Number):Vector2; [IAngularCurve2D=TrisectrixOfMaclaurin;IPolarCurve=TrisectrixOfMaclaurin;Self=TrisectrixOfMaclaurin;]; <>
        [MethodImpl(AggressiveInlining)]  public Vector2 Eval(Number t) => this.Eval(t.Turns);
// Sample(TrisectrixOfMaclaurin, Integer):_T0; [ICurve2D=TrisectrixOfMaclaurin;IAngularCurve2D=TrisectrixOfMaclaurin;IPolarCurve=TrisectrixOfMaclaurin;Self=TrisectrixOfMaclaurin;]; <_T0:IArray<Vector2>>
        [MethodImpl(AggressiveInlining)]  public _T0 Sample<_T0>(Integer numPoints){
            var _var73 = this;
            return numPoints.LinearSpace.Map((x)  => _var73.Eval(x));
        }

// ToPolyLine2D(TrisectrixOfMaclaurin, Integer):PolyLine2D; [ICurve2D=TrisectrixOfMaclaurin;IAngularCurve2D=TrisectrixOfMaclaurin;IPolarCurve=TrisectrixOfMaclaurin;Self=TrisectrixOfMaclaurin;]; <>
        [MethodImpl(AggressiveInlining)]  public PolyLine2D ToPolyLine2D(Integer numPoints) => (this.Sample(numPoints), this.Closed);
// Closed(TrisectrixOfMaclaurin):Boolean; [IOpenShape=TrisectrixOfMaclaurin;Self=TrisectrixOfMaclaurin;]; <>

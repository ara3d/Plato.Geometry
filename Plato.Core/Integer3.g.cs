...
namespace Plato
{
    ...
    public partial struct Integer3: IValue<Integer3>, IArray<Integer>
    {
        // Fields
        ...
        [MethodImpl(AggressiveInlining)]  public IArray<Integer3> Repeat(Integer n){
            var _var50 = this;
        ...
        [MethodImpl(AggressiveInlining)]  public Integer At(Integer n) { [MethodImpl(AggressiveInlining)] get => n == 0 ? A : n == 1 ? B : n == 2 ? C : throw new System.IndexOutOfRangeException(); }

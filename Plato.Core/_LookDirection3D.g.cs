...
public static LookDirection3D Identity { [MethodImpl(AggressiveInlining)] get  => (Vector3.UnitY, Constants.ZAxis3D); } 
...
[MethodImpl(AggressiveInlining)]  public static MatrixTransform3D operator *(LookDirection3D x, Matrix4x4 m) => x.Multiply(m);
...
[MethodImpl(AggressiveInlining)]  public static implicit operator MatrixTransform3D(LookDirection3D t) => t.MatrixTransform3D;

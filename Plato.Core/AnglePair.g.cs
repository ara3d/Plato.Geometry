...
namespace Plato
{
    ...
    public partial struct AnglePair: IInterval<AnglePair, Angle>
    {
        // Fields
        ...
        Angle IInterval<AnglePair, Angle>.Start { [MethodImpl(AggressiveInlining)] get => Start; }
        Angle IInterval<AnglePair, Angle>.End { [MethodImpl(AggressiveInlining)] get => End; }
        ...
        [MethodImpl(AggressiveInlining)]  public IArray<Angle> GeometricSpace(Integer count){
            var _var58 = this;
            return count.GeometricSpace.Map((x) => _var58.Lerp(x));
        }

        [MethodImpl(AggressiveInlining)]  public IArray<Angle> GeometricSpaceExclusive(Integer count){
            var _var59 = this;
            return count.GeometricSpaceExclusive.Map((x) => _var59.Lerp(x));
        }
        ...
        [MethodImpl(AggressiveInlining)]  public IArray<AnglePair> Subdivide(Integer count){
            var _var60 = this;
            return count.Intervals.Map((i) => _var60.Subdivide(i));
        }

        [MethodImpl(AggressiveInlining)]  public IArray<AnglePair> Repeat(Integer n){
            var _var61 = this;
        ...
        [MethodImpl(AggressiveInlining)]  public Angle At(Integer n) { [MethodImpl(AggressiveInlining)] get => n == 0 ? Start : n == 1 ? End : throw new System.IndexOutOfRangeException(); }

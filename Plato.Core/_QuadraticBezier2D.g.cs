...
namespace Plato
{
    ...
    public partial struct QuadraticBezier2D: IOpenCurve2D
    {
        ...
        [MethodImpl(AggressiveInlining)] public static implicit operator QuadraticBezier2D((Vector2, Vector2, Vector2) value) => new QuadraticBezier2D(value.Item1, value.Item2, value.Item3);

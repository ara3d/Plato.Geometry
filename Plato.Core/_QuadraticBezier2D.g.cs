...
namespace Plato
{
    ...
    public partial struct QuadraticBezier2D: IArray<Vector2>, IOpenCurve2D
    {
        ...
        // Eval(QuadraticBezier2D, Number):Vector2; [Self=QuadraticBezier2D;]; <>
        [MethodImpl(AggressiveInlining)]  public Vector2 Eval(Number t) => t.QuadraticBezier(this.A, this.B, this.C);
// Sample(QuadraticBezier2D, Integer):_T0; [ICurve2D=QuadraticBezier2D;IOpenCurve2D=QuadraticBezier2D;Self=QuadraticBezier2D;]; <_T0:IArray<Vector2>>
        [MethodImpl(AggressiveInlining)]  public _T0 Sample<_T0>(Integer numPoints){
            var _var56 = this;
            return numPoints.LinearSpace.Map((x)  => _var56.Eval(x));
        }

// ToPolyLine2D(QuadraticBezier2D, Integer):PolyLine2D; [ICurve2D=QuadraticBezier2D;IOpenCurve2D=QuadraticBezier2D;Self=QuadraticBezier2D;]; <>
        [MethodImpl(AggressiveInlining)]  public PolyLine2D ToPolyLine2D(Integer numPoints) => (this.Sample(numPoints), this.Closed);
// Closed(QuadraticBezier2D):Boolean; [IOpenShape=QuadraticBezier2D;IOpenShape2D=QuadraticBezier2D;IOpenCurve2D=QuadraticBezier2D;Self=QuadraticBezier2D;]; <>

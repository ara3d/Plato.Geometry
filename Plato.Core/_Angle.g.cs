...
namespace Plato
{
    ...
    public partial struct Angle: IMeasure<Angle>
    {
        ...
        [MethodImpl(AggressiveInlining)] public Angle CreateFromComponents(IArray<Number> numbers) => new Angle(numbers[0]);

        [MethodImpl(AggressiveInlining)] public Angle CreateFromNumber(Number x) => new Angle(x);
...
public Angle Zero { [MethodImpl(AggressiveInlining)] get  => this.CreateFromNumber(((Number)0)); } 
public Angle One { [MethodImpl(AggressiveInlining)] get  => this.CreateFromNumber(((Number)1)); } 
[MethodImpl(AggressiveInlining)]  public Angle FromNumber(Number x) => this.CreateFromNumber(x);
...
[MethodImpl(AggressiveInlining)]  public Angle MapComponents(System.Func<Number, Number> f) => this.CreateFromComponents(this.Components.Map(f));
[MethodImpl(AggressiveInlining)]  public Angle ZipComponents(Angle b, System.Func<Number, Number, Number> f) => this.CreateFromComponents(this.Components.Zip(b.Components, f));
[MethodImpl(AggressiveInlining)]  public Angle ZipComponents(Angle b, Angle c, System.Func<Number, Number, Number, Number> f) => this.CreateFromComponents(this.Components.Zip(b.Components, c.Components, f));

...
namespace Plato
{
    ...
    public partial struct Quad3D: IPolygon3D, IDeformable3D<Quad3D>, IArrayLike<Quad3D, Vector3>
    {
        // Fields
        ...
        public IArray<Vector3> Components { [MethodImpl(AggressiveInlining)] get => Intrinsics.MakeArray<Vector3>(A, B, C, D); }
        [MethodImpl(AggressiveInlining)] public static Quad3D CreateFromComponents(IArray<Vector3> numbers) => new Quad3D(numbers[0], numbers[1], numbers[2], numbers[3]);

        [MethodImpl(AggressiveInlining)] public static Quad3D CreateFromComponent(Vector3 x) => new Quad3D(x, x, x, x);
...
// AMBIGUOUS FUNCTIONS 3
        public IArray<Vector3> Points { [MethodImpl(AggressiveInlining)] get  => this.Components; } 

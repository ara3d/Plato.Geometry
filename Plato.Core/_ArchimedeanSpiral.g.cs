...
namespace Plato
{
    ...
    public partial struct ArchimedeanSpiral: IPolarCurve, IOpenShape
    {
        ...
        // GetRadius(ArchimedeanSpiral, Angle):Number; [Self=ArchimedeanSpiral;]; <>
        [MethodImpl(AggressiveInlining)]  public Number GetRadius(Angle t) => t.ArchimedeanSpiral(this.A, this.B);
// EvalPolar(ArchimedeanSpiral, Angle):PolarCoordinate; [IPolarCurve=ArchimedeanSpiral;Self=ArchimedeanSpiral;]; <>
        [MethodImpl(AggressiveInlining)]  public PolarCoordinate EvalPolar(Angle t) => (this.GetRadius(t), t);
// Eval(ArchimedeanSpiral, Angle):Vector2; [IPolarCurve=ArchimedeanSpiral;Self=ArchimedeanSpiral;]; <>
        [MethodImpl(AggressiveInlining)]  public Vector2 Eval(Angle t) => this.EvalPolar(t);
// Eval(ArchimedeanSpiral, Number):Vector2; [IAngularCurve2D=ArchimedeanSpiral;IPolarCurve=ArchimedeanSpiral;Self=ArchimedeanSpiral;]; <>
        [MethodImpl(AggressiveInlining)]  public Vector2 Eval(Number t) => this.Eval(t.Turns);
// Sample(ArchimedeanSpiral, Integer):_T0; [ICurve2D=ArchimedeanSpiral;IAngularCurve2D=ArchimedeanSpiral;IPolarCurve=ArchimedeanSpiral;Self=ArchimedeanSpiral;]; <_T0:IArray<Vector2>>
        [MethodImpl(AggressiveInlining)]  public _T0 Sample<_T0>(Integer numPoints){
            var _var70 = this;
            return numPoints.LinearSpace.Map((x)  => _var70.Eval(x));
        }

// ToPolyLine2D(ArchimedeanSpiral, Integer):PolyLine2D; [ICurve2D=ArchimedeanSpiral;IAngularCurve2D=ArchimedeanSpiral;IPolarCurve=ArchimedeanSpiral;Self=ArchimedeanSpiral;]; <>
        [MethodImpl(AggressiveInlining)]  public PolyLine2D ToPolyLine2D(Integer numPoints) => (this.Sample(numPoints), this.Closed);
// Closed(ArchimedeanSpiral):Boolean; [IOpenShape=ArchimedeanSpiral;Self=ArchimedeanSpiral;]; <>

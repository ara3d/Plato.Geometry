...
namespace Plato
{
    ...
    public partial struct Box: ISolid
    {
        ...
        // ClosedX(Box):Boolean; [ISolid=Box;Self=Box;]; <>
        public Boolean ClosedX { [MethodImpl(AggressiveInlining)] get  => ((Boolean)true); } 
// ClosedY(Box):Boolean; [ISolid=Box;Self=Box;]; <>
        public Boolean ClosedY { [MethodImpl(AggressiveInlining)] get  => ((Boolean)true); } 

        // Unimplemented concept functions
        // Eval(Box, Vector2):Vector3; [IProcedural=Box;TOut=Vector3;TIn=Vector2;IProceduralSurface=Box;ISolid=Box;Self=Box;]; <>

...
namespace Plato
{
    ...
    public partial struct Scaling3D: ITransform3D
    {
        ...
        [MethodImpl(AggressiveInlining)]  public Scaling3D Multiply(Number scalar) => this.Scale.Multiply(scalar);
[MethodImpl(AggressiveInlining)]  public static Scaling3D operator *(Scaling3D x, Number scalar) => x.Multiply(scalar);
...
public static Scaling3D Identity { [MethodImpl(AggressiveInlining)] get  => Vector3.Constants.One; } 
...
[MethodImpl(AggressiveInlining)]  public static implicit operator MatrixTransform3D(Scaling3D t) => t.MatrixTransform3D;

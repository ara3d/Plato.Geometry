...
namespace Plato
{
    ...
    public partial struct LineArray3D: ILineArray3D
    {
        ...
        [MethodImpl(AggressiveInlining)]  public LineArray3D Deform(System.Func<Vector3, Vector3> f){
            var _var837 = f;
            return new LineArray3D(this.Lines.Map((l) => l.Deform(_var837)));
        }

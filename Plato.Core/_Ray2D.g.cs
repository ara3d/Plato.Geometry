...
[MethodImpl(AggressiveInlining)]  public static implicit operator Ray3D(Ray2D x) => x.Ray3D;
        [MethodImpl(AggressiveInlining)]  public Ray2D Deform(System.Func<Point2D, Point2D> f) => (f.Invoke(this.Origin), f.Invoke(this.Origin.Add(this.Direction)).Normalize);

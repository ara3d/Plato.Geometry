...
namespace Plato
{
    ...
    public partial struct AnglePair: IInterval<Angle>
    {
        ...
        // Size(AnglePair):Angle; [$T=Angle;IInterval=AnglePair;T=Angle;Self=AnglePair;]; <>
        public Angle Size { [MethodImpl(AggressiveInlining)] get  => this.End.Subtract(this.Start); } 
// Lerp(AnglePair, Number):Angle; [$T=Angle;IInterval=AnglePair;T=Angle;Self=AnglePair;]; <>
        [MethodImpl(AggressiveInlining)]  public Angle Lerp(Number amount) => this.Start.Lerp(this.End, amount);
// Reverse(AnglePair):AnglePair; [$T=Angle;IInterval=AnglePair;T=Angle;Self=AnglePair;]; <>
        public AnglePair Reverse { [MethodImpl(AggressiveInlining)] get  => (this.End, this.Start); } 
// Center(AnglePair):Angle; [$T=Angle;IInterval=AnglePair;T=Angle;Self=AnglePair;]; <>
        public Angle Center { [MethodImpl(AggressiveInlining)] get  => this.Lerp(((Number)0.5)); } 
// Contains(AnglePair, Angle):Boolean; [$T=Angle;IInterval=AnglePair;T=Angle;Self=AnglePair;]; <>
        [MethodImpl(AggressiveInlining)]  public Boolean Contains(Angle value) => value.Between(this.Start, this.End);
// Contains(AnglePair, AnglePair):Boolean; [$T=Angle;IInterval=AnglePair;T=Angle;Self=AnglePair;]; <>
        [MethodImpl(AggressiveInlining)]  public Boolean Contains(AnglePair y) => this.Contains(y.Start).And(this.Contains(y.End));
// Overlaps(AnglePair, AnglePair):Boolean; [$T=Angle;IInterval=AnglePair;T=Angle;Self=AnglePair;]; <>
...
// SplitAt(AnglePair, Number):Tuple2<AnglePair, AnglePair>; [$T=Angle;IInterval=AnglePair;T=Angle;Self=AnglePair;]; <>
        [MethodImpl(AggressiveInlining)]  public Tuple2<AnglePair, AnglePair> SplitAt(Number t) => (this.Left(t), this.Right(t));
// Split(AnglePair):Tuple2<AnglePair, AnglePair>; [$T=Angle;IInterval=AnglePair;T=Angle;Self=AnglePair;]; <>
        public Tuple2<AnglePair, AnglePair> Split { [MethodImpl(AggressiveInlining)] get  => this.SplitAt(((Number)0.5)); } 
// Left(AnglePair, Number):AnglePair; [$T=Angle;IInterval=AnglePair;T=Angle;Self=AnglePair;]; <>
        [MethodImpl(AggressiveInlining)]  public AnglePair Left(Number t) => (this.Start, this.Lerp(t));
// Right(AnglePair, Number):AnglePair; [$T=Angle;IInterval=AnglePair;T=Angle;Self=AnglePair;]; <>
        [MethodImpl(AggressiveInlining)]  public AnglePair Right(Number t) => (this.Lerp(t), this.End);
// MoveTo(AnglePair, Angle):AnglePair; [$T=Angle;IInterval=AnglePair;T=Angle;Self=AnglePair;]; <>
        [MethodImpl(AggressiveInlining)]  public AnglePair MoveTo(Angle v) => (v, v.Add(this.Size));
// LeftHalf(AnglePair):AnglePair; [$T=Angle;IInterval=AnglePair;T=Angle;Self=AnglePair;]; <>
        public AnglePair LeftHalf { [MethodImpl(AggressiveInlining)] get  => this.Left(((Number)0.5)); } 
// RightHalf(AnglePair):AnglePair; [$T=Angle;IInterval=AnglePair;T=Angle;Self=AnglePair;]; <>
        public AnglePair RightHalf { [MethodImpl(AggressiveInlining)] get  => this.Right(((Number)0.5)); } 
// Recenter(AnglePair, Angle):AnglePair; [$T=Angle;IInterval=AnglePair;T=Angle;Self=AnglePair;]; <>
        [MethodImpl(AggressiveInlining)]  public AnglePair Recenter(Angle c) => (c.Subtract(this.Size.Half), c.Add(this.Size.Half));
// Clamp(AnglePair, AnglePair):AnglePair; [$T=Angle;IInterval=AnglePair;T=Angle;Self=AnglePair;]; <>
        [MethodImpl(AggressiveInlining)]  public AnglePair Clamp(AnglePair y) => (this.Clamp(y.Start), this.Clamp(y.End));
// Clamp(AnglePair, Angle):Angle; [$T=Angle;IInterval=AnglePair;T=Angle;Self=AnglePair;]; <>
        [MethodImpl(AggressiveInlining)]  public Angle Clamp(Angle value) => value.Clamp(this.Start, this.End);
// LinearSpace(AnglePair, Integer):_T0; [$T=Angle;IInterval=AnglePair;T=Angle;Self=AnglePair;]; <_T0:IArray<Angle>>
        [MethodImpl(AggressiveInlining)]  public _T0 LinearSpace<_T0>(Integer count){
            var _var49 = this;
            return count.LinearSpace.Map((x)  => _var49.Lerp(x));
        }

// LinearSpaceExclusive(AnglePair, Integer):_T0; [$T=Angle;IInterval=AnglePair;T=Angle;Self=AnglePair;]; <_T0:IArray<Angle>>
...
// Subdivide(AnglePair, Number, Number):AnglePair; [$T=Angle;IInterval=AnglePair;T=Angle;Self=AnglePair;]; <>
        [MethodImpl(AggressiveInlining)]  public AnglePair Subdivide(Number start, Number end) => (this.Lerp(start), this.Lerp(end));
// Subdivide(AnglePair, NumberInterval):AnglePair; [$T=Angle;IInterval=AnglePair;T=Angle;Self=AnglePair;]; <>
...
// Subdivide(AnglePair, Integer):_T0; [$T=Angle;IInterval=AnglePair;T=Angle;Self=AnglePair;]; <_T0:IArray<AnglePair>>

...
namespace Plato
{
    ...
    public partial struct NumberInterval: IInterval<Number>
    {
        ...
        [MethodImpl(AggressiveInlining)]  public IArray<NumberInterval> Subdivide(Integer count){
            var _var40 = this;
            return count.Intervals.Map((i) => _var40.Subdivide(i));
        }

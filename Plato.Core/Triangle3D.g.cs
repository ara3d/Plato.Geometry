...
namespace Plato
{
    ...
    public partial struct Triangle3D: IPolygon3D<Triangle3D>, IDeformable3D<Triangle3D>
    {
        ...
        // Ambiguous: could not choose a best function implementation for Barycentric(Triangle3D, Vector2):Vector3:Vector3.
        ...
        public TriangleArray3D TriangleArray3D { [MethodImpl(AggressiveInlining)] get  => new Any(TriangleArray3D, Intrinsics.MakeArray(this)); } 
        ...
        public IArray<Line3D> Lines { [MethodImpl(AggressiveInlining)] get  => Intrinsics.MakeArray<Line3D>(new Any(Line3D, this.A, this.B), new Any(Line3D, this.B, this.C), new Any(Line3D, this.C, this.A)); } 
        ...
        [MethodImpl(AggressiveInlining)]  public Triangle3D TranslateX(Number s){
            var _var155 = s;
            return this.Deform((p) => p.Add((_var155, ((Integer)0), ((Integer)0))));
        }

        [MethodImpl(AggressiveInlining)]  public Triangle3D TranslateY(Number s){
            var _var156 = s;
            return this.Deform((p) => p.Add((((Integer)0), _var156, ((Integer)0))));
        }

        [MethodImpl(AggressiveInlining)]  public Triangle3D TranslateZ(Number s){
            var _var157 = s;
            return this.Deform((p) => p.Add((((Integer)0), ((Integer)0), _var157)));
        }

        [MethodImpl(AggressiveInlining)]  public Triangle3D ScaleX(Number s){
            var _var158 = s;
            return this.Deform((p) => p.Multiply((_var158, ((Integer)1), ((Integer)1))));
        }

        [MethodImpl(AggressiveInlining)]  public Triangle3D ScaleY(Number s){
            var _var159 = s;
            return this.Deform((p) => p.Multiply((((Integer)1), _var159, ((Integer)1))));
        }

        [MethodImpl(AggressiveInlining)]  public Triangle3D ScaleZ(Number s){
            var _var160 = s;
            return this.Deform((p) => p.Multiply((((Integer)1), ((Integer)1), _var160)));
        }

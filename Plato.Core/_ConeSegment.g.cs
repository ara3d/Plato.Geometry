...
namespace Plato
{
    ...
    public partial struct ConeSegment: ISolid
    {
        ...
        // ClosedX(ConeSegment):Boolean; [ISolid=ConeSegment;Self=ConeSegment;]; <>
        public Boolean ClosedX { [MethodImpl(AggressiveInlining)] get  => ((Boolean)true); } 
// ClosedY(ConeSegment):Boolean; [ISolid=ConeSegment;Self=ConeSegment;]; <>
        public Boolean ClosedY { [MethodImpl(AggressiveInlining)] get  => ((Boolean)true); } 

        // Unimplemented concept functions
        // Eval(ConeSegment, Vector2):Vector3; [IProcedural=ConeSegment;TOut=Vector3;TIn=Vector2;IProceduralSurface=ConeSegment;ISolid=ConeSegment;Self=ConeSegment;]; <>

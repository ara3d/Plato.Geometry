...
namespace Plato
{
    ...
    public partial struct QuadArray2D: IQuadArray2D
    {
        ...
        [MethodImpl(AggressiveInlining)]  public IArray<Vector2> FaceVertices(Integer f){
            var _var232 = this;
            return this.FaceIndices(f).Map((i) => _var232.Vertex(i));
        }
        ...
        [MethodImpl(AggressiveInlining)]  public IArray<Vector2> Vertices(IArray<Integer> xs){
            var _var233 = this;
            return xs.Map((i) => _var233.Vertex(i));
        }

        public IArray<IArray<Vector2>> AllFaceVertices { [MethodImpl(AggressiveInlining)] get {
            var _var234 = this;
            return this.Indices.Slices(this.PrimitiveSize).Map((xs) => _var234.Vertices(xs));
        }
         } 

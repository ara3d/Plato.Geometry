...
namespace Plato
{
    ...
    public partial struct TRSTransform3D: ITransform3D
    {
        ...
        // Matrix(TRSTransform3D):Matrix4x4; [Self=TRSTransform3D;]; <>
...
// Identity(TRSTransform3D):TRSTransform3D; [Self=TRSTransform3D;]; <>
...
// Matrix4x4(TRSTransform3D):Matrix4x4; [ITransform3D=TRSTransform3D;Self=TRSTransform3D;]; <>
...
[MethodImpl(AggressiveInlining)]  public static implicit operator Matrix4x4(TRSTransform3D t) => t.Matrix4x4;
        // Transform(TRSTransform3D, Vector3):Vector3; [ITransform3D=TRSTransform3D;Self=TRSTransform3D;]; <>
        [MethodImpl(AggressiveInlining)]  public Vector3 Transform(Vector3 v) => v.Transform(this.Matrix);
// TransformNormal(TRSTransform3D, Vector3):Vector3; [ITransform3D=TRSTransform3D;Self=TRSTransform3D;]; <>
        [MethodImpl(AggressiveInlining)]  public Vector3 TransformNormal(Vector3 v) => v.TransformNormal(this.Matrix);
// Inverse(TRSTransform3D):MatrixTransform3D; [ITransform3D=TRSTransform3D;Self=TRSTransform3D;]; <>

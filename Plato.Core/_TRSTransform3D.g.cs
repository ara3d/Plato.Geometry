...
namespace Plato
{
    ...
    public partial struct TRSTransform3D: ITransform3D
    {
        ...
        public Matrix4x4 Matrix { [MethodImpl(AggressiveInlining)] get  => this.Translation.Multiply(this.Rotation.Multiply(this.Scale)); } 
...
[MethodImpl(AggressiveInlining)]  public static MatrixTransform3D operator *(TRSTransform3D x, Matrix4x4 m) => x.Multiply(m);
...
[MethodImpl(AggressiveInlining)]  public static implicit operator MatrixTransform3D(TRSTransform3D t) => t.MatrixTransform3D;

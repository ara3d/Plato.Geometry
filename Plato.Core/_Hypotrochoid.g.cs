...
namespace Plato
{
    ...
    public partial struct Hypotrochoid: IAngularCurve2D, IOpenShape
    {
        ...
        // Eval(Hypotrochoid, Angle):Vector2; [Self=Hypotrochoid;]; <>
        [MethodImpl(AggressiveInlining)]  public Vector2 Eval(Angle t) => t.Hypotrochoid(this.Radius1, this.Radius2, this.Dist);
// Eval(Hypotrochoid, Number):Vector2; [IAngularCurve2D=Hypotrochoid;Self=Hypotrochoid;]; <>
        [MethodImpl(AggressiveInlining)]  public Vector2 Eval(Number t) => this.Eval(t.Turns);
// Sample(Hypotrochoid, Integer):_T0; [ICurve2D=Hypotrochoid;IAngularCurve2D=Hypotrochoid;Self=Hypotrochoid;]; <_T0:IArray<Vector2>>
        [MethodImpl(AggressiveInlining)]  public _T0 Sample<_T0>(Integer numPoints){
            var _var63 = this;
            return numPoints.LinearSpace.Map((x)  => _var63.Eval(x));
        }

// ToPolyLine2D(Hypotrochoid, Integer):PolyLine2D; [ICurve2D=Hypotrochoid;IAngularCurve2D=Hypotrochoid;Self=Hypotrochoid;]; <>
        [MethodImpl(AggressiveInlining)]  public PolyLine2D ToPolyLine2D(Integer numPoints) => (this.Sample(numPoints), this.Closed);
// Closed(Hypotrochoid):Boolean; [IOpenShape=Hypotrochoid;Self=Hypotrochoid;]; <>

...
namespace Plato
{
    ...
    public partial struct Perspective3D: ITransform3D
    {
        ...
        [MethodImpl(AggressiveInlining)] public static implicit operator Perspective3D((Angle, Number, Number, Number) value) => new(value.Item1, value.Item2, value.Item3, value.Item4);
        ...
        // Matrix(Perspective3D):Matrix4x4; [Self=Perspective3D;]; <>
...
// Matrix4x4(Perspective3D):Matrix4x4; [ITransform3D=Perspective3D;Self=Perspective3D;]; <>
...
[MethodImpl(AggressiveInlining)]  public static implicit operator Matrix4x4(Perspective3D t) => t.Matrix4x4;
        // Transform(Perspective3D, Vector3):Vector3; [ITransform3D=Perspective3D;Self=Perspective3D;]; <>
        [MethodImpl(AggressiveInlining)]  public Vector3 Transform(Vector3 v) => v.Transform(this.Matrix);
// TransformNormal(Perspective3D, Vector3):Vector3; [ITransform3D=Perspective3D;Self=Perspective3D;]; <>
        [MethodImpl(AggressiveInlining)]  public Vector3 TransformNormal(Vector3 v) => v.TransformNormal(this.Matrix);
// Inverse(Perspective3D):MatrixTransform3D; [ITransform3D=Perspective3D;Self=Perspective3D;]; <>

...
[MethodImpl(AggressiveInlining)]  public static MatrixTransform3D operator *(Pose3D x, Matrix4x4 m) => x.Multiply(m);
...
[MethodImpl(AggressiveInlining)]  public static implicit operator MatrixTransform3D(Pose3D t) => t.MatrixTransform3D;

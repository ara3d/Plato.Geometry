...
[MethodImpl(AggressiveInlining)]  public static implicit operator TRSTransform3D(Pose3D p) => p.TRSTransform3D;
        // Identity(Pose3D):Pose3D; [Self=Pose3D;]; <>
        public static Pose3D Identity { [MethodImpl(AggressiveInlining)] get  => (Translation3D.Identity, Rotation3D.Identity); } 
// Matrix4x4(Pose3D):Matrix4x4; [ITransform3D=Pose3D;IRigidTransform3D=Pose3D;Self=Pose3D;]; <>
...
[MethodImpl(AggressiveInlining)]  public static implicit operator Matrix4x4(Pose3D t) => t.Matrix4x4;
        // Transform(Pose3D, Vector3):Vector3; [ITransform3D=Pose3D;IRigidTransform3D=Pose3D;Self=Pose3D;]; <>
        [MethodImpl(AggressiveInlining)]  public Vector3 Transform(Vector3 v) => v.Transform(this.Matrix);
// TransformNormal(Pose3D, Vector3):Vector3; [ITransform3D=Pose3D;IRigidTransform3D=Pose3D;Self=Pose3D;]; <>
        [MethodImpl(AggressiveInlining)]  public Vector3 TransformNormal(Vector3 v) => v.TransformNormal(this.Matrix);
// Inverse(Pose3D):MatrixTransform3D; [ITransform3D=Pose3D;IRigidTransform3D=Pose3D;Self=Pose3D;]; <>

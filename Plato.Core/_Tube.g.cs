...
namespace Plato
{
    ...
    public partial struct Tube: ISolid
    {
        ...
        // ClosedX(Tube):Boolean; [ISolid=Tube;Self=Tube;]; <>
        public Boolean ClosedX { [MethodImpl(AggressiveInlining)] get  => ((Boolean)true); } 
// ClosedY(Tube):Boolean; [ISolid=Tube;Self=Tube;]; <>
        public Boolean ClosedY { [MethodImpl(AggressiveInlining)] get  => ((Boolean)true); } 

        // Unimplemented concept functions
        // Eval(Tube, Vector2):Vector3; [IProcedural=Tube;TOut=Vector3;TIn=Vector2;IProceduralSurface=Tube;ISolid=Tube;Self=Tube;]; <>

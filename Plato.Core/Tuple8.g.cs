...
namespace Plato
{
    ...
    public partial struct Tuple8<T0, T1, T2, T3, T4, T5, T6, T7>
    {
        ...
        [MethodImpl(AggressiveInlining)] public static implicit operator Tuple8<T0, T1, T2, T3, T4, T5, T6, T7>((T0, T1, T2, T3, T4, T5, T6, T7) value) => new(value.Item1, value.Item2, value.Item3, value.Item4, value.Item5, value.Item6, value.Item7, value.Item8);

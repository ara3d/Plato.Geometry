...
[MethodImpl(AggressiveInlining)]  public Number Cubic(Number b, Number c, Number d, Number x) => this.Multiply(x.Cube).Add(b.Multiply(x.Sqr).Add(c.Multiply(x).Add(d)));
[MethodImpl(AggressiveInlining)]  public Number Quartic(Number b, Number c, Number d, Number e, Number x) => this.Multiply(x.Pow(((Integer)4))).Add(b.Multiply(x.Cube).Add(c.Multiply(x.Sqr).Add(d.Multiply(x).Add(e))));
...
[MethodImpl(AggressiveInlining)]  public Number MidPoint(Number b) => this.Add(b).Half;
...
[MethodImpl(AggressiveInlining)]  public Number Dot(Number v2) => this.Multiply(v2).Sum;
public Number Normalize { [MethodImpl(AggressiveInlining)] get  => this.MagnitudeSquared.GreaterThan(((Integer)0)) ? this.Divide(this.Magnitude) : Zero; } 
[MethodImpl(AggressiveInlining)]  public Number Reflect(Number normal) => this.Subtract(normal.Multiply(this.Dot(normal).Multiply(((Number)2))));
[MethodImpl(AggressiveInlining)]  public Number Project(Number other) => other.Multiply(this.Dot(other));
[MethodImpl(AggressiveInlining)]  public Number Distance(Number b) => b.Subtract(this).Magnitude;
[MethodImpl(AggressiveInlining)]  public Number DistanceSquared(Number b) => b.Subtract(this).MagnitudeSquared;
[MethodImpl(AggressiveInlining)]  public Angle Angle(Number b) => this.Dot(b).Divide(this.Magnitude.Multiply(b.Magnitude)).Acos;
[MethodImpl(AggressiveInlining)]  public Boolean IsParallel(Number b) => this.Dot(b).Abs.GreaterThanOrEquals(((Number)1).Subtract(Constants.Epsilon));
...
[MethodImpl(AggressiveInlining)]  public static Number FromNumber(Number x) => Number.CreateFromComponent(x);
...
public Number Pow2 { [MethodImpl(AggressiveInlining)] get  => this.MapComponents((a)  => a.Multiply(a)); } 
public Number Pow3 { [MethodImpl(AggressiveInlining)] get  => this.MapComponents((a)  => a.Multiply(a.Multiply(a))); } 
public Number Pow4 { [MethodImpl(AggressiveInlining)] get  => this.MapComponents((a)  => a.Multiply(a.Multiply(a.Multiply(a)))); } 
public Number Pow5 { [MethodImpl(AggressiveInlining)] get  => this.MapComponents((a)  => a.Multiply(a.Multiply(a.Multiply(a.Multiply(a))))); } 

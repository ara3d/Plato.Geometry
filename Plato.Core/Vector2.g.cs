...
namespace Plato
{
    ...
    public partial struct Vector2: IVector<Vector2>
    {
        ...
        public static Vector2 Zero { [MethodImpl(AggressiveInlining)] get  => ((Number)0); } 
        public static Vector2 One { [MethodImpl(AggressiveInlining)] get  => ((Number)0); } 
        public static Vector2 MinValue { [MethodImpl(AggressiveInlining)] get  => Number.MinValue; } 
        public static Vector2 MaxValue { [MethodImpl(AggressiveInlining)] get  => Number.MinValue; } 
        ...
        [MethodImpl(AggressiveInlining)]  public Vector2 MapComponents(System.Func<Number, Number> f) => this.Components.Map(f).Create();
        [MethodImpl(AggressiveInlining)]  public Vector2 ZipComponents(Vector2 b, System.Func<Number, Number, Number> f) => this.Components.Zip(b.Components, f).Create();
        [MethodImpl(AggressiveInlining)]  public Vector2 ZipComponents(Vector2 b, Vector2 c, System.Func<Number, Number, Number, Number> f) => this.Components.Zip(b.Components, c.Components, f).Create();
        ...
        public Vector2 Sqrt { [MethodImpl(AggressiveInlining)] get  => this.SquareRoot; } 
        [MethodImpl(AggressiveInlining)]  public Vector2 InversePow(Vector2 n) => this.Pow(n.Reciprocal);
        public Vector2 SmoothStep { [MethodImpl(AggressiveInlining)] get  => this.Square.Multiply(((Number)3).Subtract(this.Twice)); } 
        [MethodImpl(AggressiveInlining)]  public Vector2 MultiplyEpsilon(Vector2 y) => this.Abs.Greater(y.Abs).Multiply(Constants.Epsilon);
        ...
        public Vector2 Sqr { [MethodImpl(AggressiveInlining)] get  => this.Square; } 

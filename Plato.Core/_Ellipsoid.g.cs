...
namespace Plato
{
    ...
    public partial struct Ellipsoid: ISolid
    {
        ...
        // ClosedX(Ellipsoid):Boolean; [ISolid=Ellipsoid;Self=Ellipsoid;]; <>
        public Boolean ClosedX { [MethodImpl(AggressiveInlining)] get  => ((Boolean)true); } 
// ClosedY(Ellipsoid):Boolean; [ISolid=Ellipsoid;Self=Ellipsoid;]; <>
        public Boolean ClosedY { [MethodImpl(AggressiveInlining)] get  => ((Boolean)true); } 

        // Unimplemented concept functions
        // Eval(Ellipsoid, Vector2):Vector3; [IProcedural=Ellipsoid;TOut=Vector3;TIn=Vector2;IProceduralSurface=Ellipsoid;ISolid=Ellipsoid;Self=Ellipsoid;]; <>

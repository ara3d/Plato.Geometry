...
namespace Plato
{
    ...
    public partial struct Vector3: IVector<Vector3>
    {
        ...
        [MethodImpl(AggressiveInlining)]  public Vector3 MidPoint(Vector3 b) => this.Add(b).Divide(((Number)2));
        ...
        public static Vector3 Zero { [MethodImpl(AggressiveInlining)] get  => ((Number)0); } 
        public static Vector3 One { [MethodImpl(AggressiveInlining)] get  => ((Number)0); } 
        public static Vector3 MinValue { [MethodImpl(AggressiveInlining)] get  => Number.MinValue; } 
        public static Vector3 MaxValue { [MethodImpl(AggressiveInlining)] get  => Number.MinValue; } 
        ...
        [MethodImpl(AggressiveInlining)]  public Vector3 MapComponents(System.Func<Number, Number> f) => this.Components.Map(f).Create();
        [MethodImpl(AggressiveInlining)]  public Vector3 ZipComponents(Vector3 b, System.Func<Number, Number, Number> f) => this.Components.Zip(b.Components, f).Create();
        [MethodImpl(AggressiveInlining)]  public Vector3 ZipComponents(Vector3 b, Vector3 c, System.Func<Number, Number, Number, Number> f) => this.Components.Zip(b.Components, c.Components, f).Create();
        ...
        public Vector3 Sqrt { [MethodImpl(AggressiveInlining)] get  => this.SquareRoot; } 
        [MethodImpl(AggressiveInlining)]  public Vector3 InversePow(Vector3 n) => this.Pow(n.Reciprocal);
        public Vector3 SmoothStep { [MethodImpl(AggressiveInlining)] get  => this.Square.Multiply(((Number)3).Subtract(this.Twice)); } 
        [MethodImpl(AggressiveInlining)]  public Vector3 MultiplyEpsilon(Vector3 y) => this.Abs.Greater(y.Abs).Multiply(Constants.Epsilon);
        ...
        public Vector3 Sqr { [MethodImpl(AggressiveInlining)] get  => this.Square; } 

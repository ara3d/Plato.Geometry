...
namespace Plato
{
    ...
    public partial struct CylindricalCoordinate: ICoordinate<CylindricalCoordinate>
    {
        // Fields
        ...
        [MethodImpl(AggressiveInlining)]  public IArray<CylindricalCoordinate> Repeat(Integer n){
            var _var41 = this;
            return n.MapRange((i) => _var41);
        }

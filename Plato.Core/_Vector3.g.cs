...
[MethodImpl(AggressiveInlining)]  public static implicit operator Point3D(Vector3 x) => x.Point3D;
        ...
        public Translation3D Translation3D { [MethodImpl(AggressiveInlining)] get  => this; } 
[MethodImpl(AggressiveInlining)]  public static implicit operator Translation3D(Vector3 v) => v.Translation3D;
...
public Vector4 Vector4 { [MethodImpl(AggressiveInlining)] get  => ((Number)0).ToVector4(); } 
...
[MethodImpl(AggressiveInlining)]  public Vector3 Log(Vector3 newBase) => this.ZipComponents(newBase, (a, b)  => a.Log(b));
...
[MethodImpl(AggressiveInlining)]  public Vector3 Round(Integer digits){
            var _var188 = digits;
            return this.MapComponents((x)  => x.Round(_var188));
        }

[MethodImpl(AggressiveInlining)]  public Vector3 RoundAwayFromZero(Integer digits){
            var _var189 = digits;
            return this.MapComponents((x)  => x.RoundAwayFromZero(_var189));
        }

[MethodImpl(AggressiveInlining)]  public Vector3 RoundToZero(Integer digits){
            var _var190 = digits;
            return this.MapComponents((x)  => x.RoundToZero(_var190));
        }

[MethodImpl(AggressiveInlining)]  public Vector3 ScaleB(Integer n){
            var _var191 = n;
            return this.MapComponents((x)  => x.ScaleB(_var191));
        }

public Integer Sign { [MethodImpl(AggressiveInlining)] get  => this.MapComponents((x)  => x.Sign); } 
public Vector3 SquareRoot { [MethodImpl(AggressiveInlining)] get  => this.MapComponents((x)  => x.SquareRoot); } 
...
[MethodImpl(AggressiveInlining)]  public Vector3 Lerp(Vector3 b, Vector3 t) => this.ZipComponents(b, t, (a1, b1, t1)  => a1.Lerp(b1, t1));

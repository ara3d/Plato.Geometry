...
namespace Plato
{
    ...
    public partial struct Vector3: IVector<Vector3>
    {
        ...
        [MethodImpl(AggressiveInlining)] public Vector3 CreateFromComponents(IArray<Number> numbers) => new Vector3(numbers[0], numbers[1], numbers[2]);

        [MethodImpl(AggressiveInlining)] public Vector3 CreateFromNumber(Number x) => new Vector3(x, x, x);
...
public Vector3 UnitX { [MethodImpl(AggressiveInlining)] get  => (((Number)1), ((Number)0), ((Number)0)); } 
public Vector3 UnitY { [MethodImpl(AggressiveInlining)] get  => (((Number)0), ((Number)1), ((Number)0)); } 
public Vector3 UnitZ { [MethodImpl(AggressiveInlining)] get  => (((Number)0), ((Number)0), ((Number)1)); } 
...
[MethodImpl(AggressiveInlining)]  public Boolean IsParallel(Vector3 b) => this.Dot(b).Abs.GreaterThanOrEquals(One.Subtract(Constants.Epsilon));
...
public Vector3 Zero { [MethodImpl(AggressiveInlining)] get  => this.CreateFromNumber(((Number)0)); } 
public Vector3 One { [MethodImpl(AggressiveInlining)] get  => this.CreateFromNumber(((Number)1)); } 
[MethodImpl(AggressiveInlining)]  public Vector3 FromNumber(Number x) => this.CreateFromNumber(x);
...
[MethodImpl(AggressiveInlining)]  public Vector3 MapComponents(System.Func<Number, Number> f) => this.CreateFromComponents(this.Components.Map(f));
[MethodImpl(AggressiveInlining)]  public Vector3 ZipComponents(Vector3 b, System.Func<Number, Number, Number> f) => this.CreateFromComponents(this.Components.Zip(b.Components, f));
[MethodImpl(AggressiveInlining)]  public Vector3 ZipComponents(Vector3 b, Vector3 c, System.Func<Number, Number, Number, Number> f) => this.CreateFromComponents(this.Components.Zip(b.Components, c.Components, f));

...
public static _T0 At<_T0>(this IArray2D<_T0> xs, Integer i) => xs.At(i.Modulo(xs.NumColumns), i.Divide(xs.NumColumns));
public static _T0 At<_T0>(this IArray3D<_T0> xs, Integer i) => xs.At(i.Modulo(xs.NumColumns), i.Divide(xs.NumColumns), i.Divide(xs.NumLayers));
...
public static _T0 Middle<_T0>(this IArray<_T0> xs, Integer n) => xs.At(xs.Count.Divide(((Integer)2)));
public static Array<_T0> Slice<_T0>(this IArray<_T0> xs, Integer from, Integer to) => xs.Subarray(from, to.Subtract(from));
public static Array2D<_T0> Slices<_T0>(this IArray<_T0> xs, Integer size){
            var _var1 = size;
            {
                var _var0 = xs;
...
public static Array<_T0> NthSlice<_T0>(this IArray<_T0> xs, Integer n, Integer size) => xs.Subarray(n.Multiply(size), size);
public static Array<_T0> Subarray<_T0>(this IArray<_T0> xs, Integer from, Integer count){
            var _var3 = from;
            {
                var _var2 = xs;
...
public static Array<_T0> Skip<_T0>(this IArray<_T0> xs, Integer n) => xs.Subarray(n, xs.Count.Subtract(n));
public static Array<_T0> Take<_T0>(this IArray<_T0> xs, Integer n) => xs.Subarray(((Integer)0), n);
public static Array<_T0> TakeLast<_T0>(this IArray<_T0> xs, Integer n) => xs.Skip(xs.Count.Subtract(((Integer)1)));
public static Array<_T0> Drop<_T0>(this IArray<_T0> xs, Integer n) => xs.Take(xs.Count.Subtract(n));
public static Array<_T0> Trim<_T0>(this IArray<_T0> xs, Integer first, Integer last) => xs.Skip(first).Drop(last);
public static IArray<_T0> Rest<_T0>(this IArray<_T0> xs) => xs.Skip(((Integer)1));
public static _T1 Reduce<_T0, _T1>(this IArray<_T0> xs, _T1 acc, System.Func<_T1, _T0, _T1> f){
            var r = acc;
            {
                var i = ((Integer)0);
...
public static Boolean All<_T0>(this IArray<_T0> xs, System.Func<_T0, Boolean> f){
            {
                var i = ((Integer)0);
                while (i.LessThan(xs.Count))
                {
...
public static Boolean Any<_T0>(this IArray<_T0> xs, System.Func<_T0, Boolean> f){
            {
                var i = ((Integer)0);
                while (i.LessThan(xs.Count))
                {
...
public static Array<_T1> Map<_T0, _T1>(this IArray<_T0> xs, System.Func<_T0, _T1> f){
            var _var5 = xs;
            {
                var _var4 = f;
...
public static Array<_T2> Zip<_T0, _T1, _T2>(this IArray<_T0> xs, IArray<_T1> ys, System.Func<_T0, _T1, _T2> f){
            var _var8 = ys;
            {
                var _var7 = xs;
                {
...
public static Array<_T3> Zip<_T0, _T1, _T2, _T3>(this IArray<_T0> xs, IArray<_T1> ys, IArray<_T2> zs, System.Func<_T0, _T1, _T2, _T3> f){
            var _var12 = zs;
            {
                var _var11 = ys;
                {
...
public static _T0 ModuloAt<_T0>(this IArray<_T0> xs, Integer n) => xs.At(n.Modulo(xs.Count));
public static Array<_T0> Shift<_T0>(this IArray<_T0> xs, Integer n){
            var _var13 = xs;
            return xs.Count.MapRange((i)  => _var13.ModuloAt(i));
        }

public static Array<_T1> WithNext<_T0, _T1>(this IArray<_T0> xs, System.Func<_T0, _T0, _T1> f) => xs.Drop(((Integer)1)).Zip(xs.Skip(((Integer)1)), f);
public static Array<_T1> WithNextAndBeginning<_T0, _T1>(this IArray<_T0> xs, System.Func<_T0, _T0, _T1> f) => xs.Zip(xs.Shift(((Integer)1)), f);
public static Array<_T1> WithNext<_T0, _T1>(this IArray<_T0> xs, System.Func<_T0, _T0, _T1> f, Boolean connect) => connect ? xs.WithNextAndBeginning(f) : xs.WithNext(f);
public static Array<_T0> EveryNth<_T0>(this IArray<_T0> self, Integer n){
            var _var15 = n;
            {
                var _var14 = self;
...
public static Array2D<_T2> CartesianProduct<_T0, _T1, _T2>(this IArray<_T0> columns, IArray<_T1> rows, System.Func<_T0, _T1, _T2> func){
            var _var18 = rows;
            {
                var _var17 = columns;
                {
...
public static Array<_T0> Concat<_T0>(this IArray<_T0> xs, IArray<_T0> ys){
            var _var24 = xs;
            {
                var _var23 = ys;
                {
...
public static Array<_T0> Prepend<_T0>(this IArray<_T0> self, _T0 value){
            var _var26 = self;
            {
                var _var25 = value;
...
public static Array<_T0> Append<_T0>(this IArray<_T0> self, _T0 value){
            var _var28 = self;
            {
                var _var27 = value;
...
public static Array<_T0> PrependAndAppend<_T0>(this IArray<_T0> self, _T0 before, _T0 after) => self.Prepend(before).Append(after);
public static IArray<_T1> ZipPairs<_T0, _T1>(this IArray<_T0> xs, System.Func<_T0, _T0, _T1> f){
            var _var31 = xs;
            {
                var _var30 = xs;
                {
...
public static IArray<_T1> ZipTriplets<_T0, _T1>(this IArray<_T0> xs, System.Func<_T0, _T0, _T0, _T1> f){
            var _var35 = xs;
            {
                var _var34 = xs;
                {
...
public static IArray<_T1> ZipQuartets<_T0, _T1>(this IArray<_T0> xs, System.Func<_T0, _T0, _T0, _T0, _T1> f){
            var _var40 = xs;
            {
                var _var39 = xs;
                {
...
public static Array2D<_T1> Map<_T0, _T1>(this IArray2D<_T0> xs, System.Func<_T0, _T1> f){
            var _var42 = xs;
            {
                var _var41 = f;
...
public static IArray<_T0> Row<_T0>(this IArray2D<_T0> self, Integer row){
            var _var44 = row;
            {
                var _var43 = self;
...
public static IArray<_T0> Column<_T0>(this IArray2D<_T0> self, Integer col){
            var _var46 = col;
            {
                var _var45 = self;
...
public static Array<_T1> FlatMap<_T0, _T1>(this IArray<_T0> xs, System.Func<_T0, IArray<_T1>> f) => throw new NotImplementedException();
public static IArray<Vector2> Points(this IArray<Line2D> xs) => xs.FlatMap((x)  => x.Points);
public static IArray<Vector3> Points(this IArray<Line3D> xs) => xs.FlatMap((x)  => x.Points);
public static IArray<Vector2> Points(this IArray<Triangle2D> xs) => xs.FlatMap((x)  => x.Points);
public static IArray<Vector3> Points(this IArray<Triangle3D> xs) => xs.FlatMap((x)  => x.Points);
public static IArray<Vector2> Points(this IArray<Quad2D> xs) => xs.FlatMap((x)  => x.Points);
public static IArray<Vector3> Points(this IArray<Quad3D> xs) => xs.FlatMap((x)  => x.Points);
...
public static IArray2D<Integer4> AllQuadFaceIndices<_T0>(this IArray2D<_T0> xs, Boolean closedX, Boolean closedY) => xs.NumColumns.AllQuadFaceIndices(xs.NumRows, closedX, closedY);
}
}

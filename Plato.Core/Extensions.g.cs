...
namespace Plato
{
    public static class Extensions
    {
        ...
        public static IArray<Line2D> ToLines(this IArray<Vector2> xs, IArray<Vector2> ys) => xs.Zip(ys, (a, b) => new Any(Line2D, a, b));
        public static IArray<Line3D> ToLines(this IArray<Vector3> xs, IArray<Vector3> ys) => xs.Zip(ys, (a, b) => new Any(Line3D, a, b));

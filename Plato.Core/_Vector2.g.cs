...
namespace Plato
{
    ...
    public partial struct Vector2: INumerical<Vector2>
    {
        ...
        public Vector2 Point2D { [MethodImpl(AggressiveInlining)] get  => (this.X, this.Y); } 
...
[MethodImpl(AggressiveInlining)]  public Vector2 Log(Vector2 newBase) => this.ZipComponents(newBase, (a, b)  => a.Log(b));
...
[MethodImpl(AggressiveInlining)]  public Vector2 Round(Integer digits){
            var _var184 = digits;
            return this.MapComponents((x)  => x.Round(_var184));
        }

[MethodImpl(AggressiveInlining)]  public Vector2 RoundAwayFromZero(Integer digits){
            var _var185 = digits;
            return this.MapComponents((x)  => x.RoundAwayFromZero(_var185));
        }

[MethodImpl(AggressiveInlining)]  public Vector2 RoundToZero(Integer digits){
            var _var186 = digits;
            return this.MapComponents((x)  => x.RoundToZero(_var186));
        }

[MethodImpl(AggressiveInlining)]  public Vector2 ScaleB(Integer n){
            var _var187 = n;
            return this.MapComponents((x)  => x.ScaleB(_var187));
        }

public Integer Sign { [MethodImpl(AggressiveInlining)] get  => this.MapComponents((x)  => x.Sign); } 
public Vector2 SquareRoot { [MethodImpl(AggressiveInlining)] get  => this.MapComponents((x)  => x.SquareRoot); } 
...
[MethodImpl(AggressiveInlining)]  public Vector2 Lerp(Vector2 b, Vector2 t) => this.ZipComponents(b, t, (a1, b1, t1)  => a1.Lerp(b1, t1));

...
namespace Plato
{
    ...
    public partial struct Quad3D: IPolygon3D<Quad3D>, IDeformable3D<Quad3D>
    {
        ...
        [MethodImpl(AggressiveInlining)]  public Quad3D TranslateX(Number s){
            var _var130 = s;
            return this.Deform((p) => p.Add((_var130, ((Integer)0), ((Integer)0))));
        }

        [MethodImpl(AggressiveInlining)]  public Quad3D TranslateY(Number s){
            var _var131 = s;
            return this.Deform((p) => p.Add((((Integer)0), _var131, ((Integer)0))));
        }

        [MethodImpl(AggressiveInlining)]  public Quad3D TranslateZ(Number s){
            var _var132 = s;
            return this.Deform((p) => p.Add((((Integer)0), ((Integer)0), _var132)));
        }

        [MethodImpl(AggressiveInlining)]  public Quad3D ScaleX(Number s){
            var _var133 = s;
            return this.Deform((p) => p.Multiply((_var133, ((Integer)1), ((Integer)1))));
        }

        [MethodImpl(AggressiveInlining)]  public Quad3D ScaleY(Number s){
            var _var134 = s;
            return this.Deform((p) => p.Multiply((((Integer)1), _var134, ((Integer)1))));
        }

        [MethodImpl(AggressiveInlining)]  public Quad3D ScaleZ(Number s){
            var _var135 = s;
            return this.Deform((p) => p.Multiply((((Integer)1), ((Integer)1), _var135)));
        }

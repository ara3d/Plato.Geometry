...
namespace Plato
{
    ...
    public partial struct Line3D: IPolyLine3D<Line3D>, IOpenShape3D, IDeformable3D<Line3D>, IArray<Vector3>, IInterval<Line3D, Vector3>
    {
        // Fields
        ...
        [MethodImpl(AggressiveInlining)]  public Line3D Scale(Vector3 v){
            var _var125 = v;
            return this.Deform((p) => p.Multiply(_var125));
        }

        [MethodImpl(AggressiveInlining)]  public Line3D Scale(Number s){
            var _var126 = s;
            return this.Deform((p) => p.Multiply(_var126));
        }
        ...
        [MethodImpl(AggressiveInlining)]  public Line3D TranslateX(Number s){
            var _var127 = s;
            return this.Deform((p) => p.Add((_var127, ((Integer)0), ((Integer)0))));
        }

        [MethodImpl(AggressiveInlining)]  public Line3D TranslateY(Number s){
            var _var128 = s;
            return this.Deform((p) => p.Add((((Integer)0), _var128, ((Integer)0))));
        }

        [MethodImpl(AggressiveInlining)]  public Line3D TranslateZ(Number s){
            var _var129 = s;
            return this.Deform((p) => p.Add((((Integer)0), ((Integer)0), _var129)));
        }

        [MethodImpl(AggressiveInlining)]  public Line3D ScaleX(Number s){
            var _var130 = s;
            return this.Deform((p) => p.Multiply((_var130, ((Integer)1), ((Integer)1))));
        }

        [MethodImpl(AggressiveInlining)]  public Line3D ScaleY(Number s){
            var _var131 = s;
            return this.Deform((p) => p.Multiply((((Integer)1), _var131, ((Integer)1))));
        }

        [MethodImpl(AggressiveInlining)]  public Line3D ScaleZ(Number s){
            var _var132 = s;
            return this.Deform((p) => p.Multiply((((Integer)1), ((Integer)1), _var132)));
        }
        ...
        [MethodImpl(AggressiveInlining)]  public IArray<Line3D> Subdivide(Integer count){
            var _var138 = this;
            return count.Intervals.Map((i) => _var138.Subdivide(i));
        }

        [MethodImpl(AggressiveInlining)]  public IArray<Line3D> Repeat(Integer n){
            var _var139 = this;
            return n.MapRange((i) => _var139);
        }
        ...
        [MethodImpl(AggressiveInlining)]  public Vector3 At(Integer n) { [MethodImpl(AggressiveInlining)] get => n == 0 ? A : n == 1 ? B : throw new System.IndexOutOfRangeException(); }
        public Vector3 this[Integer n] => n == 0 ? A : n == 1 ? B : throw new System.IndexOutOfRangeException();
    }
}

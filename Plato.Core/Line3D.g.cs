...
namespace Plato
{
    ...
    public partial struct Line3D: IPolyLine3D<Line3D>, IOpenShape3D, IDeformable3D<Line3D>, IArray<Vector3>, IInterval<Vector3>
    {
        ...
        [MethodImpl(AggressiveInlining)]  public Line3D Deform(Translation3D t){
            var _var121 = t;
            return this.Deform((v) => _var121.Transform(v));
        }

        [MethodImpl(AggressiveInlining)]  public Line3D Deform(Rotation3D t){
            var _var122 = t;
            return this.Deform((v) => _var122.Transform(v));
        }
        ...
        [MethodImpl(AggressiveInlining)]  public Line3D Deform(TRSTransform3D t){
            var _var125 = t;
            return this.Deform((v) => _var125.Transform(v));
        }
        ...
        [MethodImpl(AggressiveInlining)]  public Line3D Translate(Vector3 v){
            var _var132 = v;
            return this.Deform((p) => p.Add(_var132));
        }
        ...
        [MethodImpl(AggressiveInlining)]  public Line3D Scale(Number s){
            var _var134 = s;
            return this.Deform((p) => p.Multiply(_var134));
        }
        ...
        [MethodImpl(AggressiveInlining)]  public Line3D TranslateX(Number s){
            var _var135 = s;
            return this.Deform((p) => p.Add((_var135, ((Integer)0), ((Integer)0))));
        }

        [MethodImpl(AggressiveInlining)]  public Line3D TranslateY(Number s){
            var _var136 = s;
            return this.Deform((p) => p.Add((((Integer)0), _var136, ((Integer)0))));
        }

        [MethodImpl(AggressiveInlining)]  public Line3D TranslateZ(Number s){
            var _var137 = s;
            return this.Deform((p) => p.Add((((Integer)0), ((Integer)0), _var137)));
        }

        [MethodImpl(AggressiveInlining)]  public Line3D ScaleX(Number s){
            var _var138 = s;
            return this.Deform((p) => p.Multiply((_var138, ((Integer)1), ((Integer)1))));
        }

        [MethodImpl(AggressiveInlining)]  public Line3D ScaleY(Number s){
            var _var139 = s;
            return this.Deform((p) => p.Multiply((((Integer)1), _var139, ((Integer)1))));
        }

        [MethodImpl(AggressiveInlining)]  public Line3D ScaleZ(Number s){
            var _var140 = s;
            return this.Deform((p) => p.Multiply((((Integer)1), ((Integer)1), _var140)));
        }
        ...
        [MethodImpl(AggressiveInlining)]  public IArray<Line3D> Subdivide(Integer count){
            var _var146 = this;
            return count.Intervals.Map((i) => _var146.Subdivide(i));
        }

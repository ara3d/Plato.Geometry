...
namespace Plato
{
    ...
    public partial struct Spiral: IOpenCurve2D
    {
        ...
        // Eval(Spiral, Number):Vector2; [Self=Spiral;]; <>
        [MethodImpl(AggressiveInlining)]  public Vector2 Eval(Number t) => t.Spiral(this.Radius1, this.Radius2, this.NumTurns);
// Sample(Spiral, Integer):_T0; [ICurve2D=Spiral;IOpenCurve2D=Spiral;Self=Spiral;]; <_T0:IArray<Vector2>>
        [MethodImpl(AggressiveInlining)]  public _T0 Sample<_T0>(Integer numPoints){
            var _var55 = this;
            return numPoints.LinearSpace.Map((x)  => _var55.Eval(x));
        }

// ToPolyLine2D(Spiral, Integer):PolyLine2D; [ICurve2D=Spiral;IOpenCurve2D=Spiral;Self=Spiral;]; <>
        [MethodImpl(AggressiveInlining)]  public PolyLine2D ToPolyLine2D(Integer numPoints) => (this.Sample(numPoints), this.Closed);
// Closed(Spiral):Boolean; [IOpenShape=Spiral;IOpenShape2D=Spiral;IOpenCurve2D=Spiral;Self=Spiral;]; <>

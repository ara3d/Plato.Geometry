...
[MethodImpl(AggressiveInlining)]  public Procedural<TR, Vector2> MapDomain<T0, TR>(System.Func<T0, TR> f){
    ...
    {
        var _var63 = this;
        return new Procedural<$TIn2,$TOut>((x) =>  => _var63.Eval(_var64.Invoke(x));
;
    }
}
...
[MethodImpl(AggressiveInlining)]  public Procedural<Number, Vector2> Compose(Spiral b){
    ...
    {
        var _var66 = b;
        return new Procedural<$TIn2,$TOut>((x) =>  => _var66.Eval(_var67.Eval(x));
;
    }
}
...
[MethodImpl(AggressiveInlining)]  public Procedural<TR, Number> MapDomain<T0, TR>(System.Func<T0, TR> f){
    ...
    {
        var _var71 = this;
        return new Procedural<$TIn2,$TOut>((x) =>  => _var71.Eval(_var72.Invoke(x));
;
    }
}
...
[MethodImpl(AggressiveInlining)]  public Procedural<Vector2, Number> Compose(Spiral b){
    ...
    {
        var _var74 = b;
        return new Procedural<$TIn2,$TOut>((x) =>  => _var74.Eval(_var75.Eval(x));
;
    }
}
...
[MethodImpl(AggressiveInlining)]  public Procedural<Vector2, Boolean> Threshold(Number threshold){
    var _var76 = threshold;
    return this.Map((x) =>  => x.GreaterThanOrEquals(_var76);
;
}

...
namespace Plato
{
    ...
    public partial struct Hypocycloid: IAngularCurve2D, IOpenShape
    {
        ...
        // Eval(Hypocycloid, Angle):Vector2; [Self=Hypocycloid;]; <>
        [MethodImpl(AggressiveInlining)]  public Vector2 Eval(Angle t) => t.Hypocycloid(this.Radius1, this.Radius2);
// Eval(Hypocycloid, Number):Vector2; [IAngularCurve2D=Hypocycloid;Self=Hypocycloid;]; <>
        [MethodImpl(AggressiveInlining)]  public Vector2 Eval(Number t) => this.Eval(t.Turns);
// Sample(Hypocycloid, Integer):_T0; [ICurve2D=Hypocycloid;IAngularCurve2D=Hypocycloid;Self=Hypocycloid;]; <_T0:IArray<Vector2>>
        [MethodImpl(AggressiveInlining)]  public _T0 Sample<_T0>(Integer numPoints){
            var _var61 = this;
            return numPoints.LinearSpace.Map((x)  => _var61.Eval(x));
        }

// ToPolyLine2D(Hypocycloid, Integer):PolyLine2D; [ICurve2D=Hypocycloid;IAngularCurve2D=Hypocycloid;Self=Hypocycloid;]; <>
        [MethodImpl(AggressiveInlining)]  public PolyLine2D ToPolyLine2D(Integer numPoints) => (this.Sample(numPoints), this.Closed);
// Closed(Hypocycloid):Boolean; [IOpenShape=Hypocycloid;Self=Hypocycloid;]; <>

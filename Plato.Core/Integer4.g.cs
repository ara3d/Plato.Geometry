...
namespace Plato
{
    ...
    public partial struct Integer4: IValue<Integer4>, IArray<Integer>
    {
        // Fields
        ...
        [MethodImpl(AggressiveInlining)]  public IArray<Integer4> Repeat(Integer n){
            var _var51 = this;
        ...
        [MethodImpl(AggressiveInlining)]  public Integer At(Integer n) { [MethodImpl(AggressiveInlining)] get => n == 0 ? A : n == 1 ? B : n == 2 ? C : n == 3 ? D : throw new System.IndexOutOfRangeException(); }

...
public static LookAt3D Identity { [MethodImpl(AggressiveInlining)] get  => (Origin, Constants.YAxis3D); } 
...
[MethodImpl(AggressiveInlining)]  public static implicit operator MatrixTransform3D(LookAt3D t) => t.MatrixTransform3D;

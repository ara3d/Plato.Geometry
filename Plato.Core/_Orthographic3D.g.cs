...
namespace Plato
{
    ...
    public partial struct Orthographic3D: ITransform3D
    {
        ...
        // Matrix(Orthographic3D):Matrix4x4; [Self=Orthographic3D;]; <>
...
// Matrix4x4(Orthographic3D):Matrix4x4; [ITransform3D=Orthographic3D;Self=Orthographic3D;]; <>
...
[MethodImpl(AggressiveInlining)]  public static implicit operator Matrix4x4(Orthographic3D t) => t.Matrix4x4;
        // Transform(Orthographic3D, Vector3):Vector3; [ITransform3D=Orthographic3D;Self=Orthographic3D;]; <>
        [MethodImpl(AggressiveInlining)]  public Vector3 Transform(Vector3 v) => v.Transform(this.Matrix);
// TransformNormal(Orthographic3D, Vector3):Vector3; [ITransform3D=Orthographic3D;Self=Orthographic3D;]; <>
        [MethodImpl(AggressiveInlining)]  public Vector3 TransformNormal(Vector3 v) => v.TransformNormal(this.Matrix);
// Inverse(Orthographic3D):MatrixTransform3D; [ITransform3D=Orthographic3D;Self=Orthographic3D;]; <>

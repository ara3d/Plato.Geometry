...
namespace Plato
{
    ...
    public partial struct SphericalCoordinate: ICoordinate<SphericalCoordinate>
    {
        // Fields
        ...
        [MethodImpl(AggressiveInlining)] public static implicit operator SphericalCoordinate((Number, Angle, Angle) value) => new(value.Item1, value.Item2, value.Item3);
        ...
        [MethodImpl(AggressiveInlining)]  public IArray<SphericalCoordinate> Repeat(Integer n){
            var _var38 = this;

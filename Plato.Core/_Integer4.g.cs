...
namespace Plato
{
    ...
    public partial struct Integer4: IValue, IArrayLike<Integer4, Integer>
    {
        ...
        public IArray<Integer> Components { [MethodImpl(AggressiveInlining)] get => Intrinsics.MakeArray<Integer>(A, B, C, D); }
        [MethodImpl(AggressiveInlining)] public static Integer4 CreateFromComponents(IArray<Integer> numbers) => new Integer4(numbers[0], numbers[1], numbers[2], numbers[3]);

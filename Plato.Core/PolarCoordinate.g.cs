...
namespace Plato
{
    ...
    public partial struct PolarCoordinate: ICoordinate<PolarCoordinate>
    {
        // Fields
        ...
        public Vector2 Vector2 { [MethodImpl(AggressiveInlining)] get  => new Any(Vector2, this.Angle.Cos, this.Angle.Sin).Multiply(this.Radius); } 
        [MethodImpl(AggressiveInlining)]  public static implicit operator Vector2(PolarCoordinate coord) => coord.Vector2;
        [MethodImpl(AggressiveInlining)]  public IArray<PolarCoordinate> Repeat(Integer n){
            var _var39 = this;

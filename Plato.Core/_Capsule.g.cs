...
namespace Plato
{
    ...
    public partial struct Capsule: ISolid
    {
        ...
        // ClosedX(Capsule):Boolean; [ISolid=Capsule;Self=Capsule;]; <>
        public Boolean ClosedX { [MethodImpl(AggressiveInlining)] get  => ((Boolean)true); } 
// ClosedY(Capsule):Boolean; [ISolid=Capsule;Self=Capsule;]; <>
        public Boolean ClosedY { [MethodImpl(AggressiveInlining)] get  => ((Boolean)true); } 

        // Unimplemented concept functions
        // Eval(Capsule, Vector2):Vector3; [IProcedural=Capsule;TOut=Vector3;TIn=Vector2;IProceduralSurface=Capsule;ISolid=Capsule;Self=Capsule;]; <>

...
namespace Plato
{
    ...
    public partial struct HorizontalCoordinate: ICoordinate<HorizontalCoordinate>
    {
        // Fields
        ...
        [MethodImpl(AggressiveInlining)]  public IArray<HorizontalCoordinate> Repeat(Integer n){
            var _var42 = this;

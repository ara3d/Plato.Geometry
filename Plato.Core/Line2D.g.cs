...
namespace Plato
{
    ...
    public partial struct Line2D: IPolyLine2D, IOpenShape2D, IArray<Vector2>, IInterval<Line2D, Vector2>
    {
        // Fields
        ...
        [MethodImpl(AggressiveInlining)]  public IArray<Line2D> Subdivide(Integer count){
            var _var107 = this;
            return count.Intervals.Map((i) => _var107.Subdivide(i));
        }

        [MethodImpl(AggressiveInlining)]  public IArray<Line2D> Repeat(Integer n){
            var _var108 = this;
        ...
        [MethodImpl(AggressiveInlining)]  public Vector2 At(Integer n) { [MethodImpl(AggressiveInlining)] get => n == 0 ? A : n == 1 ? B : throw new System.IndexOutOfRangeException(); }
        public Vector2 this[Integer n] => n == 0 ? A : n == 1 ? B : throw new System.IndexOutOfRangeException();
    }
}

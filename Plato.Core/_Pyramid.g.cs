...
namespace Plato
{
    ...
    public partial struct Pyramid: ISolid
    {
        ...
        // ClosedX(Pyramid):Boolean; [ISolid=Pyramid;Self=Pyramid;]; <>
        public Boolean ClosedX { [MethodImpl(AggressiveInlining)] get  => ((Boolean)true); } 
// ClosedY(Pyramid):Boolean; [ISolid=Pyramid;Self=Pyramid;]; <>
        public Boolean ClosedY { [MethodImpl(AggressiveInlining)] get  => ((Boolean)true); } 

        // Unimplemented concept functions
        // Eval(Pyramid, Vector2):Vector3; [IProcedural=Pyramid;TOut=Vector3;TIn=Vector2;IProceduralSurface=Pyramid;ISolid=Pyramid;Self=Pyramid;]; <>

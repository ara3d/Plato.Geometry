...
namespace Plato
{
    ...
    public partial struct QuadGrid3D: IQuadGrid3D<QuadGrid3D>
    {
        ...
        [MethodImpl(AggressiveInlining)]  public QuadGrid3D Deform(System.Func<Vector3, Vector3> f) => new Any(QuadGrid3D, this.PointGrid.Map(f), this.ClosedX, this.ClosedY);
        ...
        public IArray<Quad3D> Quads { [MethodImpl(AggressiveInlining)] get  => this.AllFaceVertices.Map((xs) => new Any(Quad3D, xs.At(((Integer)0)), xs.At(((Integer)1)), xs.At(((Integer)2)), xs.At(((Integer)3)))); } 
        [MethodImpl(AggressiveInlining)]  public IArray<Vector3> FaceVertices(Integer f){
            var _var285 = this;
            return this.FaceIndices(f).Map((i) => _var285.Vertex(i));
        }
        ...
        [MethodImpl(AggressiveInlining)]  public IArray<Vector3> Vertices(IArray<Integer> xs){
            var _var286 = this;
            return xs.Map((i) => _var286.Vertex(i));
        }

        public IArray<IArray<Vector3>> AllFaceVertices { [MethodImpl(AggressiveInlining)] get {
            var _var287 = this;
            return this.Indices.Slices(this.PrimitiveSize).Map((xs) => _var287.Vertices(xs));
        }
         } 
        ...
        [MethodImpl(AggressiveInlining)]  public QuadGrid3D Deform(ITransform3D t){
            var _var288 = t;
            return this.Deform((v) => _var288.Transform(v));
        }

        [MethodImpl(AggressiveInlining)]  public QuadGrid3D Translate(Vector3 v){
            var _var289 = v;
            return this.Deform((p) => p.Add(_var289));
        }
        ...
        [MethodImpl(AggressiveInlining)]  public QuadGrid3D Scale(Vector3 v){
            var _var290 = v;
            return this.Deform((p) => p.Multiply(_var290));
        }

        [MethodImpl(AggressiveInlining)]  public QuadGrid3D Scale(Number s){
            var _var291 = s;
            return this.Deform((p) => p.Multiply(_var291));
        }
        ...
        [MethodImpl(AggressiveInlining)]  public QuadGrid3D TranslateX(Number s){
            var _var292 = s;
            return this.Deform((p) => p.Add((_var292, ((Integer)0), ((Integer)0))));
        }

        [MethodImpl(AggressiveInlining)]  public QuadGrid3D TranslateY(Number s){
            var _var293 = s;
            return this.Deform((p) => p.Add((((Integer)0), _var293, ((Integer)0))));
        }

        [MethodImpl(AggressiveInlining)]  public QuadGrid3D TranslateZ(Number s){
            var _var294 = s;
            return this.Deform((p) => p.Add((((Integer)0), ((Integer)0), _var294)));
        }

        [MethodImpl(AggressiveInlining)]  public QuadGrid3D ScaleX(Number s){
            var _var295 = s;
            return this.Deform((p) => p.Multiply((_var295, ((Integer)1), ((Integer)1))));
        }

        [MethodImpl(AggressiveInlining)]  public QuadGrid3D ScaleY(Number s){
            var _var296 = s;
            return this.Deform((p) => p.Multiply((((Integer)1), _var296, ((Integer)1))));
        }

        [MethodImpl(AggressiveInlining)]  public QuadGrid3D ScaleZ(Number s){
            var _var297 = s;
            return this.Deform((p) => p.Multiply((((Integer)1), ((Integer)1), _var297)));
        }

...
namespace Plato
{
    ...
    public partial struct ConchoidOfDeSluze: IPolarCurve, IOpenShape
    {
        ...
        // GetRadius(ConchoidOfDeSluze, Angle):Number; [Self=ConchoidOfDeSluze;]; <>
        [MethodImpl(AggressiveInlining)]  public Number GetRadius(Angle t) => t.ConchoidOfDeSluze(this.A);
// EvalPolar(ConchoidOfDeSluze, Angle):PolarCoordinate; [IPolarCurve=ConchoidOfDeSluze;Self=ConchoidOfDeSluze;]; <>
        [MethodImpl(AggressiveInlining)]  public PolarCoordinate EvalPolar(Angle t) => (this.GetRadius(t), t);
// Eval(ConchoidOfDeSluze, Angle):Vector2; [IPolarCurve=ConchoidOfDeSluze;Self=ConchoidOfDeSluze;]; <>
        [MethodImpl(AggressiveInlining)]  public Vector2 Eval(Angle t) => this.EvalPolar(t);
// Eval(ConchoidOfDeSluze, Number):Vector2; [IAngularCurve2D=ConchoidOfDeSluze;IPolarCurve=ConchoidOfDeSluze;Self=ConchoidOfDeSluze;]; <>
        [MethodImpl(AggressiveInlining)]  public Vector2 Eval(Number t) => this.Eval(t.Turns);
// Sample(ConchoidOfDeSluze, Integer):_T0; [ICurve2D=ConchoidOfDeSluze;IAngularCurve2D=ConchoidOfDeSluze;IPolarCurve=ConchoidOfDeSluze;Self=ConchoidOfDeSluze;]; <_T0:IArray<Vector2>>
        [MethodImpl(AggressiveInlining)]  public _T0 Sample<_T0>(Integer numPoints){
            var _var74 = this;
            return numPoints.LinearSpace.Map((x)  => _var74.Eval(x));
        }

// ToPolyLine2D(ConchoidOfDeSluze, Integer):PolyLine2D; [ICurve2D=ConchoidOfDeSluze;IAngularCurve2D=ConchoidOfDeSluze;IPolarCurve=ConchoidOfDeSluze;Self=ConchoidOfDeSluze;]; <>
        [MethodImpl(AggressiveInlining)]  public PolyLine2D ToPolyLine2D(Integer numPoints) => (this.Sample(numPoints), this.Closed);
// Closed(ConchoidOfDeSluze):Boolean; [IOpenShape=ConchoidOfDeSluze;Self=ConchoidOfDeSluze;]; <>

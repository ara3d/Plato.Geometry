...
[MethodImpl(AggressiveInlining)]  public static implicit operator Quaternion(LookRotation r) => r.Quaternion;
        // Identity(LookRotation):LookRotation; [Self=LookRotation;]; <>
        public static LookRotation Identity { [MethodImpl(AggressiveInlining)] get  => (Vector3.UnitY, Vector3.UnitZ); } 
// Transform(LookRotation, Vector3):Vector3; [IRotationalTransform3D=LookRotation;Self=LookRotation;]; <>
        [MethodImpl(AggressiveInlining)]  public Vector3 Transform(Vector3 v) => v.Transform(this.Quaternion);
// TransformNormal(LookRotation, Vector3):Vector3; [IRotationalTransform3D=LookRotation;Self=LookRotation;]; <>
        [MethodImpl(AggressiveInlining)]  public Vector3 TransformNormal(Vector3 v) => v.TransformNormal(this.Quaternion);
// Rotation(LookRotation):Rotation3D; [IRotationalTransform3D=LookRotation;Self=LookRotation;]; <>
        public Rotation3D Rotation { [MethodImpl(AggressiveInlining)] get  => this.Quaternion; } 
// Translation(LookRotation):Translation3D; [IRotationalTransform3D=LookRotation;Self=LookRotation;]; <>
        public Translation3D Translation { [MethodImpl(AggressiveInlining)] get  => Translation3D.Identity; } 
// Matrix4x4(LookRotation):Matrix4x4; [ITransform3D=LookRotation;IRigidTransform3D=LookRotation;IRotationalTransform3D=LookRotation;Self=LookRotation;]; <>
...
[MethodImpl(AggressiveInlining)]  public static implicit operator Matrix4x4(LookRotation t) => t.Matrix4x4;
        // Inverse(LookRotation):MatrixTransform3D; [ITransform3D=LookRotation;IRigidTransform3D=LookRotation;IRotationalTransform3D=LookRotation;Self=LookRotation;]; <>

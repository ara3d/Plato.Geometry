...
namespace Plato
{
    ...
    public partial struct LookRotation: IRotationalTransform3D
    {
        ...
        public Matrix4x4 Matrix { [MethodImpl(AggressiveInlining)] get  => Matrix4x4.CreateWorld(Zero, this.Forward, this.Up); } 
...
[MethodImpl(AggressiveInlining)]  public static implicit operator Quaternion(LookRotation r) => r.Quaternion;
        public LookRotation Identity { [MethodImpl(AggressiveInlining)] get  => (Vector3.UnitY, Vector3.UnitZ); } 

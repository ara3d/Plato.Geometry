...
namespace Plato
{
    ...
    public partial struct LookRotation: IRotationalTransform3D
    {
        ...
        public static readonly LookRotation Default = default;
        ...
        public Matrix4x4 Matrix { [MethodImpl(AggressiveInlining)] get  => Matrix4x4.CreateWorld(((Number)0), this.Forward, this.Up); } 

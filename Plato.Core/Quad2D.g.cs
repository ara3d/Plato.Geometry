...
namespace Plato
{
    ...
    public partial struct Quad2D: IPolygon2D
    {
        ...
        public TriangleArray2D TriangleArray2D { [MethodImpl(AggressiveInlining)] get  => new Any(TriangleArray2D, this.Triangles); } 
        ...
        public IArray<Line2D> Lines { [MethodImpl(AggressiveInlining)] get  => Intrinsics.MakeArray<Line2D>(new Any(Line2D, this.A, this.B), new Any(Line2D, this.B, this.C), new Any(Line2D, this.C, this.D), new Any(Line2D, this.D, this.A)); } 
        public IArray<Triangle2D> Triangles { [MethodImpl(AggressiveInlining)] get  => Intrinsics.MakeArray<Triangle2D>(new Any(Triangle2D, this.A, this.B, this.C), new Any(Triangle2D, this.C, this.D, this.A)); } 
        ...
        [MethodImpl(AggressiveInlining)]  public IArray<Vector2> Sample(Integer numPoints){
            var _var101 = this;
            return numPoints.LinearSpace.Map((x) => _var101.Eval(x));
        }
        ...
        [MethodImpl(AggressiveInlining)]  public Vector2 At(Integer n) { [MethodImpl(AggressiveInlining)] get => n == 0 ? A : n == 1 ? B : n == 2 ? C : n == 3 ? D : throw new System.IndexOutOfRangeException(); }
        public Vector2 this[Integer n] => n == 0 ? A : n == 1 ? B : n == 2 ? C : n == 3 ? D : throw new System.IndexOutOfRangeException();

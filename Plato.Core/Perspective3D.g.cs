...
namespace Plato
{
    ...
    public partial struct Perspective3D: ITransform3D
    {
        ...
        public Matrix4x4 Matrix { [MethodImpl(AggressiveInlining)] get  => Matrix4x4.CreatePerspectiveFieldOfView(this.FOV, this.AspectRatio, this.Near, this.Far); } 
        ...
        public Perspective3D Inverse { [MethodImpl(AggressiveInlining)] get  => new Any(MatrixTransform3D, this.Matrix.Invert); } 

...
namespace Plato
{
    ...
    public partial struct Ellipse: IAngularCurve2D, IClosedCurve2D
    {
        ...
        // Eval(Ellipse, Angle):Vector2; [Self=Ellipse;]; <>
        [MethodImpl(AggressiveInlining)]  public Vector2 Eval(Angle t) => t.UnitCircle.Multiply(this.Size).Add(this.Center);
// Eval(Ellipse, Number):Vector2; [IAngularCurve2D=Ellipse;Self=Ellipse;]; <>
        [MethodImpl(AggressiveInlining)]  public Vector2 Eval(Number t) => this.Eval(t.Turns);
// Sample(Ellipse, Integer):_T0; [ICurve2D=Ellipse;IAngularCurve2D=Ellipse;Self=Ellipse;]; <_T0:IArray<Vector2>>
        [MethodImpl(AggressiveInlining)]  public _T0 Sample<_T0>(Integer numPoints){
            var _var59 = this;
            return numPoints.LinearSpace.Map((x)  => _var59.Eval(x));
        }

// ToPolyLine2D(Ellipse, Integer):PolyLine2D; [ICurve2D=Ellipse;IAngularCurve2D=Ellipse;Self=Ellipse;]; <>
        [MethodImpl(AggressiveInlining)]  public PolyLine2D ToPolyLine2D(Integer numPoints) => (this.Sample(numPoints), this.Closed);
// Closed(Ellipse):Boolean; [IClosedShape=Ellipse;IClosedShape2D=Ellipse;IClosedCurve2D=Ellipse;Self=Ellipse;]; <>

...
namespace Plato
{
    ...
    public partial struct IdentityTransform3D: IValue, IRotationalTransform3D
    {
        ...
        // Matrix(IdentityTransform3D):Matrix4x4; [Self=IdentityTransform3D;]; <>
        public Matrix4x4 Matrix { [MethodImpl(AggressiveInlining)] get  => Matrix4x4.Identity; } 
// Quaternion(IdentityTransform3D):Quaternion; [Self=IdentityTransform3D;]; <>
...
[MethodImpl(AggressiveInlining)]  public static implicit operator Quaternion(IdentityTransform3D t) => t.Quaternion;
        // Transform(IdentityTransform3D, Vector3):Vector3; [Self=IdentityTransform3D;]; <>
        [MethodImpl(AggressiveInlining)]  public Vector3 Transform(Vector3 v) => v;
// TransformDirection(IdentityTransform3D, Vector3):Vector3; [Self=IdentityTransform3D;]; <>
        [MethodImpl(AggressiveInlining)]  public Vector3 TransformDirection(Vector3 v) => v;
// TransformNormal(IdentityTransform3D, Vector3):Vector3; [IRotationalTransform3D=IdentityTransform3D;Self=IdentityTransform3D;]; <>
        [MethodImpl(AggressiveInlining)]  public Vector3 TransformNormal(Vector3 v) => v.TransformNormal(this.Quaternion);
// Rotation(IdentityTransform3D):Rotation3D; [IRotationalTransform3D=IdentityTransform3D;Self=IdentityTransform3D;]; <>
        public Rotation3D Rotation { [MethodImpl(AggressiveInlining)] get  => this.Quaternion; } 
// Translation(IdentityTransform3D):Translation3D; [IRotationalTransform3D=IdentityTransform3D;Self=IdentityTransform3D;]; <>
        public Translation3D Translation { [MethodImpl(AggressiveInlining)] get  => Translation3D.Identity; } 
// Matrix4x4(IdentityTransform3D):Matrix4x4; [ITransform3D=IdentityTransform3D;IRigidTransform3D=IdentityTransform3D;IRotationalTransform3D=IdentityTransform3D;Self=IdentityTransform3D;]; <>
...
[MethodImpl(AggressiveInlining)]  public static implicit operator Matrix4x4(IdentityTransform3D t) => t.Matrix4x4;
        // Inverse(IdentityTransform3D):MatrixTransform3D; [ITransform3D=IdentityTransform3D;IRigidTransform3D=IdentityTransform3D;IRotationalTransform3D=IdentityTransform3D;Self=IdentityTransform3D;]; <>

...
namespace Plato
{
    ...
    public partial struct CubicBezier2D: IOpenCurve2D
    {
        ...
        [MethodImpl(AggressiveInlining)] public static implicit operator CubicBezier2D((Vector2, Vector2, Vector2, Vector2) value) => new CubicBezier2D(value.Item1, value.Item2, value.Item3, value.Item4);

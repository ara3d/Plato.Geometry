...
namespace Plato
{
    ...
    public partial struct CubicBezier2D: IArray<Vector2>, IOpenCurve2D
    {
        ...
        // Eval(CubicBezier2D, Number):Vector2; [Self=CubicBezier2D;]; <>
        [MethodImpl(AggressiveInlining)]  public Vector2 Eval(Number t) => t.QuadraticBezier(this.A, this.B, this.C);
// Sample(CubicBezier2D, Integer):_T0; [ICurve2D=CubicBezier2D;IOpenCurve2D=CubicBezier2D;Self=CubicBezier2D;]; <_T0:IArray<Vector2>>
        [MethodImpl(AggressiveInlining)]  public _T0 Sample<_T0>(Integer numPoints){
            var _var57 = this;
            return numPoints.LinearSpace.Map((x)  => _var57.Eval(x));
        }

// ToPolyLine2D(CubicBezier2D, Integer):PolyLine2D; [ICurve2D=CubicBezier2D;IOpenCurve2D=CubicBezier2D;Self=CubicBezier2D;]; <>
        [MethodImpl(AggressiveInlining)]  public PolyLine2D ToPolyLine2D(Integer numPoints) => (this.Sample(numPoints), this.Closed);
// Closed(CubicBezier2D):Boolean; [IOpenShape=CubicBezier2D;IOpenShape2D=CubicBezier2D;IOpenCurve2D=CubicBezier2D;Self=CubicBezier2D;]; <>

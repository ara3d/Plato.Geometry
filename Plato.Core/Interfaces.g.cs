...
// Created on 2025-03-09 8:07:44 PM
...
{
    IInterpolatable Lerp(IInterpolatable b, Number t);
}
...
{
    IDeformable2D Deform(System.Func<Vector2, Vector2> f);
}
public interface IDeformable3D<Self>
{
    IDeformable3D Deform(System.Func<Vector3, Vector3> f);
}

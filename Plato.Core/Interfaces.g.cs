...
public interface IVector<Self>: IInterpolatable<Self>, IAdditive<Self>, IScalarArithmetic<Self>, IArrayLike<Self, Number> where Self : IVector<Self>
    {
    }
...
public interface INumerical<Self>: IVector<Self>, IArithmetic<Self> where Self : INumerical<Self>
    {
    }
...
public interface IMeasure<Self>: IOrderable<Self>, IVector<Self> where Self : IMeasure<Self>
    {
    }

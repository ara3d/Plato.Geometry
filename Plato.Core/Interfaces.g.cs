...
namespace Plato
{
    ...
    public interface INumerical<Self>: IInterpolatable<Self>, IScalarArithmetic<Self>, IAdditive<Self>
    {
        Integer NumComponents { get; }
        IArray<Number> Components { get; }
        Self Create(IArray<Number> xs);
    }
    ...
    public interface IArithmetic<Self>: IAdditive<Self>, IMultiplicativeWithInverse<Self>, IDivisible<Self>, IModulo<Self>
    {
    }
    public interface IRealNumber<Self>: INumerical<Self>, IOrderable<Self>, IArithmetic<Self>
    {
    }
    public interface IWholeNumber<Self>: IOrderable<Self>, IArithmetic<Self>, IInterpolatable<Self>
    {
    }
    public interface IMeasure<Self>: IOrderable<Self>, INumerical<Self>
    {
    }

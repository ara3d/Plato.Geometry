...
[MethodImpl(AggressiveInlining)]  public Point3D Barycentric(Vector2 uv) => this.A.Barycentric(this.B, this.C, uv);
...
[MethodImpl(AggressiveInlining)]  public IArray<Vector3> Sample(Integer numPoints){
            var _var126 = this;
            return numPoints.LinearSpace.Map((x)  => _var126.Eval(x));
        }

...
[MethodImpl(AggressiveInlining)]  public static implicit operator LineArray3D(Triangle3D t) => t.LineArray3D;
        // TriangleArray3D(Triangle3D):TriangleArray3D; [Self=Triangle3D;]; <>
...
[MethodImpl(AggressiveInlining)]  public static implicit operator TriangleArray3D(Triangle3D t) => t.TriangleArray3D;
        // TriangleMesh3D(Triangle3D):TriangleMesh3D; [Self=Triangle3D;]; <>
...
[MethodImpl(AggressiveInlining)]  public static implicit operator TriangleMesh3D(Triangle3D g) => g.TriangleMesh3D;
        // Points(Triangle3D):_T0; [Self=Triangle3D;]; <_T0:IArray<Vector3>>
        public _T0 Points<_T0> { [MethodImpl(AggressiveInlining)] get  => Intrinsics.MakeArray(this.A, this.B, this.C); } 
// Lines(Triangle3D):_T0; [Self=Triangle3D;]; <_T0:IArray<Line3D>>
        public _T0 Lines<_T0> { [MethodImpl(AggressiveInlining)] get  => Intrinsics.MakeArray(new Line3D(this.A, this.B), new Line3D(this.B, this.C), new Line3D(this.C, this.A)); } 
// Deform(Triangle3D, Function1<Vector3, Vector3>):Triangle3D; [Self=Triangle3D;]; <>
...
// Sample(Triangle3D, Integer):_T0; [ICurve3D=Triangle3D;IPolyLine3D=Triangle3D;IPolygon3D=Triangle3D;Self=Triangle3D;]; <_T0:IArray<Vector3>>
        [MethodImpl(AggressiveInlining)]  public _T0 Sample<_T0>(Integer numPoints){
            var _var128 = this;
            return numPoints.LinearSpace.Map((x)  => _var128.Eval(x));
        }

// ToPolyLine3D(Triangle3D, Integer):PolyLine3D; [ICurve3D=Triangle3D;IPolyLine3D=Triangle3D;IPolygon3D=Triangle3D;Self=Triangle3D;]; <>
        [MethodImpl(AggressiveInlining)]  public PolyLine3D ToPolyLine3D(Integer numPoints) => (this.Sample(numPoints), this.Closed);
// Closed(Triangle3D):Boolean; [IClosedShape=Triangle3D;IClosedShape3D=Triangle3D;IPolygon3D=Triangle3D;Self=Triangle3D;]; <>
        public Boolean Closed { [MethodImpl(AggressiveInlining)] get  => ((Boolean)true); } 
// Deform(Triangle3D, _T0):Triangle3D; [IDeformable3D=Triangle3D;Self=Triangle3D;]; <_T0:ITransform3D>
        [MethodImpl(AggressiveInlining)]  public Triangle3D Deform<_T0>(_T0 t){
            var _var129 = t;
            return this.Deform((v)  => _var129.Transform(v));
        }

// Translate(Triangle3D, Vector3):Triangle3D; [IDeformable3D=Triangle3D;Self=Triangle3D;]; <>
        [MethodImpl(AggressiveInlining)]  public Triangle3D Translate(Vector3 v){
            var _var130 = v;
            return this.Deform((p)  => p.Add(_var130));
        }

// Rotate(Triangle3D, Quaternion):Triangle3D; [IDeformable3D=Triangle3D;Self=Triangle3D;]; <>
        [MethodImpl(AggressiveInlining)]  public Triangle3D Rotate(Quaternion q){
            var _var131 = q;
            return this.Deform((v)  => _var131.Transform(v));
        }

// Scale(Triangle3D, Vector3):Triangle3D; [IDeformable3D=Triangle3D;Self=Triangle3D;]; <>
        [MethodImpl(AggressiveInlining)]  public Triangle3D Scale(Vector3 v){
            var _var132 = v;
            return this.Deform((p)  => p.Multiply(_var132));
        }

// Scale(Triangle3D, Number):Triangle3D; [IDeformable3D=Triangle3D;Self=Triangle3D;]; <>
        [MethodImpl(AggressiveInlining)]  public Triangle3D Scale(Number s){
            var _var133 = s;
            return this.Deform((p)  => p.Multiply(_var133));
        }

// RotateX(Triangle3D, Angle):Triangle3D; [IDeformable3D=Triangle3D;Self=Triangle3D;]; <>
        [MethodImpl(AggressiveInlining)]  public Triangle3D RotateX(Angle a) => this.Rotate(a.RotateX);
// RotateY(Triangle3D, Angle):Triangle3D; [IDeformable3D=Triangle3D;Self=Triangle3D;]; <>
        [MethodImpl(AggressiveInlining)]  public Triangle3D RotateY(Angle a) => this.Rotate(a.RotateY);
// RotateZ(Triangle3D, Angle):Triangle3D; [IDeformable3D=Triangle3D;Self=Triangle3D;]; <>
        [MethodImpl(AggressiveInlining)]  public Triangle3D RotateZ(Angle a) => this.Rotate(a.RotateZ);
// TranslateX(Triangle3D, Number):Triangle3D; [IDeformable3D=Triangle3D;Self=Triangle3D;]; <>
...
// TranslateY(Triangle3D, Number):Triangle3D; [IDeformable3D=Triangle3D;Self=Triangle3D;]; <>
...
// TranslateZ(Triangle3D, Number):Triangle3D; [IDeformable3D=Triangle3D;Self=Triangle3D;]; <>
...
// ScaleX(Triangle3D, Number):Triangle3D; [IDeformable3D=Triangle3D;Self=Triangle3D;]; <>
...
// ScaleY(Triangle3D, Number):Triangle3D; [IDeformable3D=Triangle3D;Self=Triangle3D;]; <>
...
// ScaleZ(Triangle3D, Number):Triangle3D; [IDeformable3D=Triangle3D;Self=Triangle3D;]; <>
        ...
        // PrimitiveSize(Triangle3D):Integer; [IPrimitiveGeometry=Triangle3D;IPrimitiveGeometry3D=Triangle3D;IPointGeometry3D=Triangle3D;IPolyLine3D=Triangle3D;IPolygon3D=Triangle3D;Self=Triangle3D;]; <>
        public Integer PrimitiveSize => throw new NotImplementedException();
// NumPrimitives(Triangle3D):Integer; [IPrimitiveGeometry=Triangle3D;IPrimitiveGeometry3D=Triangle3D;IPointGeometry3D=Triangle3D;IPolyLine3D=Triangle3D;IPolygon3D=Triangle3D;Self=Triangle3D;]; <>
        public Integer NumPrimitives => throw new NotImplementedException();
// Corners(Triangle3D):_T0; [IPrimitiveGeometry3D=Triangle3D;IPointGeometry3D=Triangle3D;IPolyLine3D=Triangle3D;IPolygon3D=Triangle3D;Self=Triangle3D;]; <_T0:IArray<Vector3>>
        public _T0 Corners<_T0> => throw new NotImplementedException();
// Eval(Triangle3D, Number):Vector3; [IProcedural=Triangle3D;TOut=TRange;TIn=Number;ICurve=Triangle3D;TRange=Vector3;ICurve3D=Triangle3D;IPolyLine3D=Triangle3D;IPolygon3D=Triangle3D;Self=Triangle3D;]; <>

...
namespace Plato
{
    ...
    public partial struct Triangle3D: IPolygon3D, IDeformable3D<Triangle3D>, IArrayLike<Triangle3D, Vector3>
    {
        // Fields
        ...
        public IArray<Vector3> Components { [MethodImpl(AggressiveInlining)] get => Intrinsics.MakeArray<Vector3>(A, B, C); }
        [MethodImpl(AggressiveInlining)] public static Triangle3D CreateFromComponents(IArray<Vector3> numbers) => new Triangle3D(numbers[0], numbers[1], numbers[2]);

        [MethodImpl(AggressiveInlining)] public static Triangle3D CreateFromComponent(Vector3 x) => new Triangle3D(x, x, x);
...
[MethodImpl(AggressiveInlining)]  public Vector3 At(Integer n) => this.Components.At(n);

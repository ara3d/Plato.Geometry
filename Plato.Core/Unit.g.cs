...
// Created on 2025-01-19 1:21:36 PM
...
namespace Plato
{
    ...
    public partial struct Unit: IReal<Unit>
    {
        ...
        [MethodImpl(AggressiveInlining)] public Boolean NotEquals(Unit other) => !Value.Equals(other.Value);
        ...
        public Unit Reciprocal { [MethodImpl(AggressiveInlining)] get  => this.One.Divide(this); } 
        ...
        public Unit PlusOne { [MethodImpl(AggressiveInlining)] get  => this.Add(((Number)1)); } 
        public Unit MinusOne { [MethodImpl(AggressiveInlining)] get  => this.Subtract(((Number)1)); } 
        public Unit FromOne { [MethodImpl(AggressiveInlining)] get  => this.Add(((Number)1)).Negative; } 
        public static Unit Zero { [MethodImpl(AggressiveInlining)] get  => ((Number)0); } 
        public static Unit One { [MethodImpl(AggressiveInlining)] get  => ((Number)1); } 
        ...
        public Unit Hundredth { [MethodImpl(AggressiveInlining)] get  => this.Divide(((Number)100)); } 
        public Unit Thousandth { [MethodImpl(AggressiveInlining)] get  => this.Divide(((Number)1000)); } 
        public Unit Millionth { [MethodImpl(AggressiveInlining)] get  => this.Thousandth.Thousandth; } 
        public Unit Billionth { [MethodImpl(AggressiveInlining)] get  => this.Thousandth.Millionth; } 

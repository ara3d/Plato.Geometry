...
namespace Plato
{
    public static class Intrinsics
    {
        ...
        [MethodImpl(AggressiveInlining)] public static Number At(this Vector8 self, int index) => self[index];
        [MethodImpl(AggressiveInlining)] public static int Count(this Vector8 self) => self.Count;

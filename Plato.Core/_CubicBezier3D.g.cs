...
namespace Plato
{
    ...
    public partial struct CubicBezier3D: IOpenShape
    {
        ...
        [MethodImpl(AggressiveInlining)] public static implicit operator CubicBezier3D((Vector3, Vector3, Vector3, Vector3) value) => new CubicBezier3D(value.Item1, value.Item2, value.Item3, value.Item4);
        ...
        [MethodImpl(AggressiveInlining)]  public Vector3 Eval(Number t) => this.A.CubicBezier(this.B, this.C, this.D, t);

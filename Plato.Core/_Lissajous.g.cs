...
[MethodImpl(AggressiveInlining)]  public IArray<Vector2> Sample(Integer numPoints){
    var _var239 = this;
    return numPoints.LinearSpace.Map((x) =>  => _var239.Eval(x);
;
}
...
[MethodImpl(AggressiveInlining)]  public Procedural<Number, TR> Combine<TR>(Lissajous b, System.Func<TR, TR, TR> f){
    var _var242 = b;
    {
        ...
        {
            var _var240 = f;
            return (x) =>  => _var240.Invoke(_var241.Eval(x), _var242.Eval(x));
;
        }
    }
}
...
[MethodImpl(AggressiveInlining)]  public Procedural<TR, Vector2> MapDomain<T0, TR>(System.Func<T0, TR> f){
    ...
    {
        var _var243 = this;
        return new Procedural<$TIn2,$TOut>((x) =>  => _var243.Eval(_var244.Invoke(x));
;
    }
}
...
[MethodImpl(AggressiveInlining)]  public Procedural<Number, Vector2> Compose(Lissajous b){
    ...
    {
        var _var246 = b;
        return new Procedural<$TIn2,$TOut>((x) =>  => _var246.Eval(_var247.Eval(x));
;
    }
}
...
[MethodImpl(AggressiveInlining)]  public Procedural<Vector2, TR> Combine<TR>(Lissajous b, System.Func<TR, TR, TR> f){
    var _var250 = b;
    {
        ...
        {
            var _var248 = f;
            return (x) =>  => _var248.Invoke(_var249.Eval(x), _var250.Eval(x));
;
        }
    }
}
...
[MethodImpl(AggressiveInlining)]  public Procedural<TR, Number> MapDomain<T0, TR>(System.Func<T0, TR> f){
    ...
    {
        var _var251 = this;
        return new Procedural<$TIn2,$TOut>((x) =>  => _var251.Eval(_var252.Invoke(x));
;
    }
}
...
[MethodImpl(AggressiveInlining)]  public Procedural<Vector2, Number> Compose(Lissajous b){
    ...
    {
        var _var254 = b;
        return new Procedural<$TIn2,$TOut>((x) =>  => _var254.Eval(_var255.Eval(x));
;
    }
}
...
[MethodImpl(AggressiveInlining)]  public Procedural<Vector2, Boolean> Threshold(Number threshold){
    var _var256 = threshold;
    return this.Map((x) =>  => x.GreaterThanOrEquals(_var256);
;
}

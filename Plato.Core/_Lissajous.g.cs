...
namespace Plato
{
    ...
    public partial struct Lissajous: IAngularCurve2D, IOpenShape
    {
        ...
        // Eval(Lissajous, Angle):Vector2; [Self=Lissajous;]; <>
        [MethodImpl(AggressiveInlining)]  public Vector2 Eval(Angle t) => t.Lissajous(this.A, this.B, this.Delta);
// Eval(Lissajous, Number):Vector2; [IAngularCurve2D=Lissajous;Self=Lissajous;]; <>
        [MethodImpl(AggressiveInlining)]  public Vector2 Eval(Number t) => this.Eval(t.Turns);
// Sample(Lissajous, Integer):_T0; [ICurve2D=Lissajous;IAngularCurve2D=Lissajous;Self=Lissajous;]; <_T0:IArray<Vector2>>
        [MethodImpl(AggressiveInlining)]  public _T0 Sample<_T0>(Integer numPoints){
            var _var65 = this;
            return numPoints.LinearSpace.Map((x)  => _var65.Eval(x));
        }

// ToPolyLine2D(Lissajous, Integer):PolyLine2D; [ICurve2D=Lissajous;IAngularCurve2D=Lissajous;Self=Lissajous;]; <>
        [MethodImpl(AggressiveInlining)]  public PolyLine2D ToPolyLine2D(Integer numPoints) => (this.Sample(numPoints), this.Closed);
// Closed(Lissajous):Boolean; [IOpenShape=Lissajous;Self=Lissajous;]; <>

...
[MethodImpl(AggressiveInlining)]  public IArray<Vector2> Sample(Integer numPoints){
    var _var581 = this;
    return numPoints.LinearSpace.Map((x) =>  => _var581.Eval(x);
;
}
...
[MethodImpl(AggressiveInlining)]  public Procedural<Number, TR> Combine<TR>(Quad2D b, System.Func<TR, TR, TR> f){
    var _var584 = b;
    {
        ...
        {
            var _var582 = f;
            return (x) =>  => _var582.Invoke(_var583.Eval(x), _var584.Eval(x));
;
        }
    }
}
...
[MethodImpl(AggressiveInlining)]  public Procedural<TR, Vector2> MapDomain<T0, TR>(System.Func<T0, TR> f){
    ...
    {
        var _var585 = this;
        return new Procedural<$TIn2,$TOut>((x) =>  => _var585.Eval(_var586.Invoke(x));
;
    }
}
...
[MethodImpl(AggressiveInlining)]  public Procedural<Number, Vector2> Compose(Quad2D b){
    ...
    {
        var _var588 = b;
        return new Procedural<$TIn2,$TOut>((x) =>  => _var588.Eval(_var589.Eval(x));
;
    }
}
...
[MethodImpl(AggressiveInlining)]  public Procedural<Vector2, TR> Combine<TR>(Quad2D b, System.Func<TR, TR, TR> f){
    var _var592 = b;
    {
        ...
        {
            var _var590 = f;
            return (x) =>  => _var590.Invoke(_var591.Eval(x), _var592.Eval(x));
;
        }
    }
}
...
[MethodImpl(AggressiveInlining)]  public Procedural<TR, Number> MapDomain<T0, TR>(System.Func<T0, TR> f){
    ...
    {
        var _var593 = this;
        return new Procedural<$TIn2,$TOut>((x) =>  => _var593.Eval(_var594.Invoke(x));
;
    }
}
...
[MethodImpl(AggressiveInlining)]  public Procedural<Vector2, Number> Compose(Quad2D b){
    ...
    {
        var _var596 = b;
        return new Procedural<$TIn2,$TOut>((x) =>  => _var596.Eval(_var597.Eval(x));
;
    }
}
...
[MethodImpl(AggressiveInlining)]  public Procedural<Vector2, Boolean> Threshold(Number threshold){
    var _var598 = threshold;
    return this.Map((x) =>  => x.GreaterThanOrEquals(_var598);
;
}

...
[MethodImpl(AggressiveInlining)]  public static implicit operator Quad3D(Quad2D x) => x.Quad3D;
        public Quad2D Unit { [MethodImpl(AggressiveInlining)] get  => ((((Number)0), ((Number)0)), (((Number)1), ((Number)0)), (((Number)1), ((Number)1)), (((Number)0), ((Number)1))); } 
...
public _T0 Lines<_T0> where _T0 : IArray<_T0> { [MethodImpl(AggressiveInlining)] get  => Intrinsics.MakeArray(new Line2D(this.A, this.B), new Line2D(this.B, this.C), new Line2D(this.C, this.D), new Line2D(this.D, this.A)); } 
public _T0 Triangles<_T0> where _T0 : IArray<_T0> { [MethodImpl(AggressiveInlining)] get  => Intrinsics.MakeArray(new Triangle2D(this.A, this.B, this.C), new Triangle2D(this.C, this.D, this.A)); } 

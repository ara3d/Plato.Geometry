...
namespace Plato
{
    ...
    public partial struct Quad2D: IPolygon2D, IArrayLike<Quad2D, Vector2>
    {
        // Fields
        ...
        public IArray<Vector2> Components { [MethodImpl(AggressiveInlining)] get => Intrinsics.MakeArray<Vector2>(A, B, C, D); }
        [MethodImpl(AggressiveInlining)] public static Quad2D CreateFromComponents(IArray<Vector2> numbers) => new Quad2D(numbers[0], numbers[1], numbers[2], numbers[3]);

        [MethodImpl(AggressiveInlining)] public static Quad2D CreateFromComponent(Vector2 x) => new Quad2D(x, x, x, x);

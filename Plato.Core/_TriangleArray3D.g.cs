...
public partial struct TriangleArray3D: ITriangleArray3D
{
    ...
    var _var882 = f;
    return new TriangleArray3D(this.Triangles.Map((t) =>  => t.Deform(_var882);
;
}

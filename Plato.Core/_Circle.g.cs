...
[MethodImpl(AggressiveInlining)]  public IArray<Vector2> Sample(Integer numPoints){
    var _var113 = this;
    return numPoints.LinearSpace.Map((x) =>  => _var113.Eval(x);
;
}
...
[MethodImpl(AggressiveInlining)]  public Procedural<Number, TR> Combine<TR>(Circle b, System.Func<TR, TR, TR> f){
    var _var116 = b;
    {
        ...
        {
            var _var114 = f;
            return (x) =>  => _var114.Invoke(_var115.Eval(x), _var116.Eval(x));
;
        }
    }
}
...
[MethodImpl(AggressiveInlining)]  public Procedural<TR, Vector2> MapDomain<T0, TR>(System.Func<T0, TR> f){
    ...
    {
        var _var117 = this;
        return new Procedural<$TIn2,$TOut>((x) =>  => _var117.Eval(_var118.Invoke(x));
;
    }
}
...
[MethodImpl(AggressiveInlining)]  public Procedural<Number, Vector2> Compose(Circle b){
    ...
    {
        var _var120 = b;
        return new Procedural<$TIn2,$TOut>((x) =>  => _var120.Eval(_var121.Eval(x));
;
    }
}
...
[MethodImpl(AggressiveInlining)]  public Procedural<Vector2, TR> Combine<TR>(Circle b, System.Func<TR, TR, TR> f){
    var _var124 = b;
    {
        ...
        {
            var _var122 = f;
            return (x) =>  => _var122.Invoke(_var123.Eval(x), _var124.Eval(x));
;
        }
    }
}
...
[MethodImpl(AggressiveInlining)]  public Procedural<TR, Number> MapDomain<T0, TR>(System.Func<T0, TR> f){
    ...
    {
        var _var125 = this;
        return new Procedural<$TIn2,$TOut>((x) =>  => _var125.Eval(_var126.Invoke(x));
;
    }
}
...
[MethodImpl(AggressiveInlining)]  public Procedural<Vector2, Number> Compose(Circle b){
    ...
    {
        var _var128 = b;
        return new Procedural<$TIn2,$TOut>((x) =>  => _var128.Eval(_var129.Eval(x));
;
    }
}
...
[MethodImpl(AggressiveInlining)]  public Procedural<Vector2, Boolean> Threshold(Number threshold){
    var _var130 = threshold;
    return this.Map((x) =>  => x.GreaterThanOrEquals(_var130);
;
}

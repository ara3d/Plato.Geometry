...
namespace Plato
{
    ...
    public partial struct Vector8: IVector<Vector8>
    {
        ...
        [MethodImpl(AggressiveInlining)] public Vector8 CreateFromComponents(IArray<Number> numbers) => new Vector8(numbers[0], numbers[1], numbers[2], numbers[3], numbers[4], numbers[5], numbers[6], numbers[7]);

        [MethodImpl(AggressiveInlining)] public Vector8 CreateFromNumber(Number x) => new Vector8(x, x, x, x, x, x, x, x);
...
[MethodImpl(AggressiveInlining)]  public Boolean IsParallel(Vector8 b) => this.Dot(b).Abs.GreaterThanOrEquals(One.Subtract(Constants.Epsilon));
...
public Vector8 Zero { [MethodImpl(AggressiveInlining)] get  => this.CreateFromNumber(((Number)0)); } 
public Vector8 One { [MethodImpl(AggressiveInlining)] get  => this.CreateFromNumber(((Number)1)); } 
[MethodImpl(AggressiveInlining)]  public Vector8 FromNumber(Number x) => this.CreateFromNumber(x);
...
[MethodImpl(AggressiveInlining)]  public Vector8 MapComponents(System.Func<Number, Number> f) => this.CreateFromComponents(this.Components.Map(f));
[MethodImpl(AggressiveInlining)]  public Vector8 ZipComponents(Vector8 b, System.Func<Number, Number, Number> f) => this.CreateFromComponents(this.Components.Zip(b.Components, f));
[MethodImpl(AggressiveInlining)]  public Vector8 ZipComponents(Vector8 b, Vector8 c, System.Func<Number, Number, Number, Number> f) => this.CreateFromComponents(this.Components.Zip(b.Components, c.Components, f));

...
namespace Plato
{
    ...
    public partial struct Vector8: IVector<Vector8>
    {
        ...
        public IVectorLike<Vector8> Cube { [MethodImpl(AggressiveInlining)] get  => this.MapComponents((x1)  => x1.Cube); } 
public IVectorLike<Vector8> Normalize { [MethodImpl(AggressiveInlining)] get  => this.MagnitudeSquared.GreaterThan(((Integer)0)) ? this.Divide(this.Magnitude) : Constants.Zero; } 
...
[MethodImpl(AggressiveInlining)]  public Vector8 Cubic(Vector8 b, Vector8 c, Vector8 d, Number x) => this.Multiply(x.Cube).Add(b.Multiply(x.Sqr).Add(c.Multiply(x).Add(d)));
[MethodImpl(AggressiveInlining)]  public Vector8 Quartic(Vector8 b, Vector8 c, Vector8 d, Vector8 e, Number x) => this.Multiply(x.Pow(((Integer)4))).Add(b.Multiply(x.Cube).Add(c.Multiply(x.Sqr).Add(d.Multiply(x).Add(e))));
...
[MethodImpl(AggressiveInlining)]  public Vector8 Log(Vector8 newBase) => this.ZipComponents(newBase, (a, b)  => a.Log(b));
...
[MethodImpl(AggressiveInlining)]  public Vector8 Round(Integer digits){
            var _var196 = digits;
            return this.MapComponents((x)  => x.Round(_var196));
        }

[MethodImpl(AggressiveInlining)]  public Vector8 RoundAwayFromZero(Integer digits){
            var _var197 = digits;
            return this.MapComponents((x)  => x.RoundAwayFromZero(_var197));
        }

[MethodImpl(AggressiveInlining)]  public Vector8 RoundToZero(Integer digits){
            var _var198 = digits;
            return this.MapComponents((x)  => x.RoundToZero(_var198));
        }

[MethodImpl(AggressiveInlining)]  public Vector8 ScaleB(Integer n){
            var _var199 = n;
            return this.MapComponents((x)  => x.ScaleB(_var199));
        }

public Integer Sign { [MethodImpl(AggressiveInlining)] get  => this.MapComponents((x)  => x.Sign); } 
public Vector8 SquareRoot { [MethodImpl(AggressiveInlining)] get  => this.MapComponents((x)  => x.SquareRoot); } 

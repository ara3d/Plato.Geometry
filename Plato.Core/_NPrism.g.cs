...
namespace Plato
{
    ...
    public partial struct NPrism: ISolid
    {
        ...
        // ClosedX(NPrism):Boolean; [ISolid=NPrism;Self=NPrism;]; <>
        public Boolean ClosedX { [MethodImpl(AggressiveInlining)] get  => ((Boolean)true); } 
// ClosedY(NPrism):Boolean; [ISolid=NPrism;Self=NPrism;]; <>
        public Boolean ClosedY { [MethodImpl(AggressiveInlining)] get  => ((Boolean)true); } 

        // Unimplemented concept functions
        // Eval(NPrism, Vector2):Vector3; [IProcedural=NPrism;TOut=Vector3;TIn=Vector2;IProceduralSurface=NPrism;ISolid=NPrism;Self=NPrism;]; <>

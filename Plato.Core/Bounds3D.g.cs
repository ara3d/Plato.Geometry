...
namespace Plato
{
    ...
    public partial struct Bounds3D: IBounds<Vector3>, IDeformable3D<Bounds3D>
    {
        ...
        [MethodImpl(AggressiveInlining)]  public Bounds3D Deform(ITransform3D t){
            var _var79 = t;
            return this.Deform((v) => _var79.Transform(v));
        }

        [MethodImpl(AggressiveInlining)]  public Bounds3D Translate(Vector3 v){
            var _var80 = v;
            return this.Deform((p) => p.Add(_var80));
        }
        ...
        [MethodImpl(AggressiveInlining)]  public Bounds3D Scale(Vector3 v){
            var _var81 = v;
            return this.Deform((p) => p.Multiply(_var81));
        }

        [MethodImpl(AggressiveInlining)]  public Bounds3D Scale(Number s){
            var _var82 = s;
            return this.Deform((p) => p.Multiply(_var82));
        }
        ...
        [MethodImpl(AggressiveInlining)]  public Bounds3D TranslateX(Number s){
            var _var83 = s;
            return this.Deform((p) => p.Add((_var83, ((Integer)0), ((Integer)0))));
        }

        [MethodImpl(AggressiveInlining)]  public Bounds3D TranslateY(Number s){
            var _var84 = s;
            return this.Deform((p) => p.Add((((Integer)0), _var84, ((Integer)0))));
        }

        [MethodImpl(AggressiveInlining)]  public Bounds3D TranslateZ(Number s){
            var _var85 = s;
            return this.Deform((p) => p.Add((((Integer)0), ((Integer)0), _var85)));
        }

        [MethodImpl(AggressiveInlining)]  public Bounds3D ScaleX(Number s){
            var _var86 = s;
            return this.Deform((p) => p.Multiply((_var86, ((Integer)1), ((Integer)1))));
        }

        [MethodImpl(AggressiveInlining)]  public Bounds3D ScaleY(Number s){
            var _var87 = s;
            return this.Deform((p) => p.Multiply((((Integer)1), _var87, ((Integer)1))));
        }

        [MethodImpl(AggressiveInlining)]  public Bounds3D ScaleZ(Number s){
            var _var88 = s;
            return this.Deform((p) => p.Multiply((((Integer)1), ((Integer)1), _var88)));
        }

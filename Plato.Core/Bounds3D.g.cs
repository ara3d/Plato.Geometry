...
namespace Plato
{
    ...
    public partial struct Bounds3D: IBounds<Bounds3D, Vector3>, IDeformable3D<Bounds3D>
    {
        // Fields
        ...
        Vector3 IBounds<Bounds3D, Vector3>.Min { [MethodImpl(AggressiveInlining)] get => Min; }
        Vector3 IBounds<Bounds3D, Vector3>.Max { [MethodImpl(AggressiveInlining)] get => Max; }
        ...
        public static Bounds3D Empty { [MethodImpl(AggressiveInlining)] get  => (Vector3.MaxValue, Vector3.MinValue); } 
        ...
        [MethodImpl(AggressiveInlining)]  public IArray<Bounds3D> Repeat(Integer n){
            var _var112 = this;
            return n.MapRange((i) => _var112);
        }

        [MethodImpl(AggressiveInlining)]  public Bounds3D Deform(ITransform3D t){
            var _var113 = t;
            return this.Deform((v) => _var113.Transform(v));
        }

        [MethodImpl(AggressiveInlining)]  public Bounds3D Translate(Vector3 v){
            var _var114 = v;
            return this.Deform((p) => p.Add(_var114));
        }
        ...
        [MethodImpl(AggressiveInlining)]  public Bounds3D Scale(Vector3 v){
            var _var115 = v;
            return this.Deform((p) => p.Multiply(_var115));
        }

        [MethodImpl(AggressiveInlining)]  public Bounds3D Scale(Number s){
            var _var116 = s;
            return this.Deform((p) => p.Multiply(_var116));
        }
        ...
        [MethodImpl(AggressiveInlining)]  public Bounds3D TranslateX(Number s){
            var _var117 = s;
            return this.Deform((p) => p.Add((_var117, ((Integer)0), ((Integer)0))));
        }

        [MethodImpl(AggressiveInlining)]  public Bounds3D TranslateY(Number s){
            var _var118 = s;
            return this.Deform((p) => p.Add((((Integer)0), _var118, ((Integer)0))));
        }

        [MethodImpl(AggressiveInlining)]  public Bounds3D TranslateZ(Number s){
            var _var119 = s;
            return this.Deform((p) => p.Add((((Integer)0), ((Integer)0), _var119)));
        }

        [MethodImpl(AggressiveInlining)]  public Bounds3D ScaleX(Number s){
            var _var120 = s;
            return this.Deform((p) => p.Multiply((_var120, ((Integer)1), ((Integer)1))));
        }

        [MethodImpl(AggressiveInlining)]  public Bounds3D ScaleY(Number s){
            var _var121 = s;
            return this.Deform((p) => p.Multiply((((Integer)1), _var121, ((Integer)1))));
        }

        [MethodImpl(AggressiveInlining)]  public Bounds3D ScaleZ(Number s){
            var _var122 = s;
            return this.Deform((p) => p.Multiply((((Integer)1), ((Integer)1), _var122)));
        }

...
namespace Plato
{
    ...
    public partial struct Matrix4x4: IValue, IArrayLike<Matrix4x4, Number>
    {
        ...
        public MatrixTransform3D MatrixTransform3D { [MethodImpl(AggressiveInlining)] get  => this; } 
[MethodImpl(AggressiveInlining)]  public static implicit operator MatrixTransform3D(Matrix4x4 m) => m.MatrixTransform3D;
        public MatrixTransform3D Transform { [MethodImpl(AggressiveInlining)] get  => this; } 

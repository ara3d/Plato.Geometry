...
[MethodImpl(AggressiveInlining)]  public IArray<Vector2> Sample(Integer numPoints){
    var _var599 = this;
    return numPoints.LinearSpace.Map((x) =>  => _var599.Eval(x);
;
}
...
[MethodImpl(AggressiveInlining)]  public Procedural<TR, Vector2> MapDomain<T0, TR>(System.Func<T0, TR> f){
    ...
    {
        var _var603 = this;
        return new Procedural<$TIn2,$TOut>((x) =>  => _var603.Eval(_var604.Invoke(x));
;
    }
}
...
[MethodImpl(AggressiveInlining)]  public Procedural<Number, Vector2> Compose(Line2D b){
    ...
    {
        var _var606 = b;
        return new Procedural<$TIn2,$TOut>((x) =>  => _var606.Eval(_var607.Eval(x));
;
    }
}
...
[MethodImpl(AggressiveInlining)]  public Procedural<Vector2, TR> Combine<TR>(Line2D b, System.Func<TR, TR, TR> f){
    var _var610 = b;
    {
        ...
        {
            var _var608 = f;
            return (x) =>  => _var608.Invoke(_var609.Eval(x), _var610.Eval(x));
;
        }
    }
}
...
[MethodImpl(AggressiveInlining)]  public Procedural<TR, Number> MapDomain<T0, TR>(System.Func<T0, TR> f){
    ...
    {
        var _var611 = this;
        return new Procedural<$TIn2,$TOut>((x) =>  => _var611.Eval(_var612.Invoke(x));
;
    }
}
...
[MethodImpl(AggressiveInlining)]  public Procedural<Vector2, Number> Compose(Line2D b){
    ...
    {
        var _var614 = b;
        return new Procedural<$TIn2,$TOut>((x) =>  => _var614.Eval(_var615.Eval(x));
;
    }
}
...
[MethodImpl(AggressiveInlining)]  public Procedural<Vector2, Boolean> Threshold(Number threshold){
    var _var616 = threshold;
    return this.Map((x) =>  => x.GreaterThanOrEquals(_var616);
;
}
...
[MethodImpl(AggressiveInlining)]  public IArray<Line2D> Subdivide(Integer count){
    var _var621 = this;
    return count.Intervals.Map((i) =>  => _var621.Subdivide(i);
;
}

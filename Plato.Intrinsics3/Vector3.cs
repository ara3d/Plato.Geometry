...
namespace Plato
{
    ...
    public partial struct Vector3 : IEquatable<Vector3>
    {
        ...
        [MethodImpl(AggressiveInlining)]
        public Vector3(Number x) : this(x, x, x) { }
        ...
        /// </summary>
        [MethodImpl(AggressiveInlining)]
        public static Boolean operator ==(Vector3 left, Vector3 right) => left.ToSystem() == right.ToSystem();
        ...
        /// </summary>
        [MethodImpl(AggressiveInlining)]
        public bool Equals(Vector3 other) => ToSystem().Equals(other.ToSystem());
        ...
        /// </summary>
        [MethodImpl(AggressiveInlining)]
        public Number Dot(Vector3 right) => SNVector3.Dot(this, right);

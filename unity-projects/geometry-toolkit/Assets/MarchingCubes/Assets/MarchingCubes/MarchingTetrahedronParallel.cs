...
{
    /*
    public struct MarchingTetrahedronParallel : IJobParallelFor
    {
        public static float3[] EdgeVertex;
        public static float3[] CubePosition;
        public static float3[] TetrahedronPosition;
        public static float[] TetrahedronValue;
        ...
        public void Generate(VoxelData voxelData, IList<Vector3> verts)
        {
                ...
                for (var y = 0; y < height - 1; y++)
                {
                    for (var z = 0; z < depth - 1; z++)
                    {
                        ...
                        for (var i = 0; i < 8; i++)
                        {
                            ...
                            var iy = y + VertexOffset[i, 1];
                            var iz = z + VertexOffset[i, 2];
                            Cube[i] = voxelData.IsOccupied(new int3(ix, iy, iz)) ? 1 : 0;
                        }

...
namespace Plato
{
    ...
    /// and there are a float of bit-oriented functions around them. The intent of the
    ...
    public partial struct Vector8 : IEquatable<Vector8>
    {
        ...
        [MethodImpl(AggressiveInlining)]
        public Vector8(float scalar) => Value = Vector256.Create(scalar);

        [MethodImpl(AggressiveInlining)]
        public Vector8(float f0, float f1, float f2, float f3, float f4, float f5, float f6, float f7)
        ...
        [MethodImpl(AggressiveInlining)]
        public static implicit operator Vector8(float value) => new(value);
        ...
        [MethodImpl(AggressiveInlining)]
        public static Vector8 operator *(Vector8 left, float scalar) => Vector256.Multiply(left.Value, scalar);

        [MethodImpl(AggressiveInlining)]
        public static Vector8 operator *(float scalar, Vector8 right) => Vector256.Multiply(scalar, right.Value);

        [MethodImpl(AggressiveInlining)]
        public static Vector8 operator /(Vector8 left, Vector8 right) => Vector256.Divide(left.Value, right.Value);

        [MethodImpl(AggressiveInlining)]
        public static Vector8 operator /(Vector8 left, float scalar) => Vector256.Divide(left.Value, scalar);

        [MethodImpl(AggressiveInlining)]
        public static Vector8 operator /(float scalar, Vector8 right) => Vector256.Divide(new Vector8(scalar), right.Value);
        ...
        [MethodImpl(AggressiveInlining)]
        public float Dot(Vector8 other) => Vector256.Dot(Value, other.Value);
        ...
        [MethodImpl(AggressiveInlining)]
        public Vector8 WithElement(int i, float f) => Vector256.WithElement(Value, i, f);

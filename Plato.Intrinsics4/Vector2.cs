...
namespace Plato
{
    ...
    public partial struct Vector2 : IEquatable<Vector2>
    {
        ...
        public readonly SNVector2 Value;
        ...
        /// <summary>
        /// Returns the maximum magnitude float of two <see cref="Vector2"/> instances.
        /// </summary>
        [MethodImpl(AggressiveInlining)]
        public Vector2 MaxMagnitudeNumber(Vector2 value2) => SNVector2.MaxMagnitudeNumber(this, value2);

        /// <summary>
        /// Returns the maximum float of two <see cref="Vector2"/> instances.
        /// </summary>
        [MethodImpl(AggressiveInlining)]
        public Vector2 Maxfloat(Vector2 value2) => SNVector2.MaxNumber(this, value2);
        ...
        /// <summary>
        /// Returns the minimum magnitude float of two <see cref="Vector2"/> instances.
        /// </summary>
        [MethodImpl(AggressiveInlining)]
        public Vector2 MinMagnitudeNumber(Vector2 value2) => SNVector2.MinMagnitudeNumber(this, value2);

        /// <summary>
        /// Returns the minimum float of two <see cref="Vector2"/> instances.
        /// </summary>
        [MethodImpl(AggressiveInlining)]

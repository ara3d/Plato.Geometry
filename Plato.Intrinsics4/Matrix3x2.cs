...
namespace Plato
{
    ...
    public partial struct Matrix3x2 : IEquatable<Matrix3x2>
    {
        ...
        [MethodImpl(AggressiveInlining)]
        public static Matrix3x2 operator *(Matrix3x2 value1, float scalar)
            => FromSystem(value1.ToSystem() * scalar);

        [MethodImpl(AggressiveInlining)]
        public static Matrix3x2 operator *(float scalar, Matrix3x2 value1)
            => value1 * scalar;
        ...
        [MethodImpl(AggressiveInlining)]
        public Matrix3x2 Lerp(Matrix3x2 matrix2, float amount)

namespace Ara3D.DoublePrecision
{
    ...
    public readonly partial struct TriFace
    {
        ...
        public Ara3D.SinglePrecision.TriFace ChangePrecision() => (Index.ChangePrecision(), VertexIndices.ChangePrecision());
        public static implicit operator Ara3D.SinglePrecision.TriFace(TriFace self) => self.ChangePrecision();
    ...
    public readonly partial struct SimpleVertex
    {
        ...
        public Ara3D.SinglePrecision.SimpleVertex ChangePrecision() => (Index.ChangePrecision(), Position.ChangePrecision(), Normal.ChangePrecision(), UV.ChangePrecision(), Color.ChangePrecision());
        public static implicit operator Ara3D.SinglePrecision.SimpleVertex(SimpleVertex self) => self.ChangePrecision();

...
namespace Plato.Geometry.IO
{
    ...
    {
        public static IEnumerable<string> ObjLines(TriangleMesh mesh, IArray<Vector2D> uvs = null)
        {
            // Write the vertices 
        ...
        public static void WriteObj(this TriangleMesh mesh, string filePath)

...
namespace Plato.Geometry
{
    ...
    {
        public IArray<double> Xs { get; }
        public IArray<double> Ys { get; }
        public IArray2D<Vector2D> Uvs { get; }
        public bool ClosedX { get; }
        public bool ClosedY { get; }
        public IArray2D<Integer4> Indices { get; }

        public SurfaceDiscretization(Integer nColumns, Integer nRows, Boolean closedX, Boolean closedY)
        {
            ClosedX = closedX;
            ClosedY = closedY;
